                    ...
                    <section id="page-title" class="block with-img with-service-items">
                        <div class="wrapper d-flex flex-column justify-content-center">
                            <div class="page-title-body page-title-body-space-left">
                                <div class="title">
                                    <h1 class="large">Tathaastu Life <br>Vastu Consultancy</h1>
                                </div>
                            ...
                            <div class="img-size-1">
                                <div class="img object-fit">
                                    <div class="object-fit-cover">
                                        <img src="assets/img/demo/02_img.jpg" alt="Team">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="team-member">
                                        <div class="team-member-top">
                                            <div class="img object-fit">
                                                <div class="object-fit-cover">
                                                    <img src="assets/img/demo/03_img.jpg" alt="Tom Henders">
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="team-member">
                                        <div class="team-member-top">
                                            <div class="img object-fit">
                                                <div class="object-fit-cover">
                                                    <img src="assets/img/demo/04_img.jpg" alt="Andrew Mike">
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="team-member">
                                        <div class="team-member-top">
                                            <div class="img object-fit">
                                                <div class="object-fit-cover">
                                                    <img src="assets/img/demo/05_img.jpg" alt="Rosie Ford">
                                                </div>
                                            </div>
                                                ...
                                                <a title="5 Tips for Sustainable Business Success" href="news-single-post.html">
                                                    <div class="img object-fit overflow-hidden">
                                                        <div class="object-fit-cover transform-scale-h">
                                                            <img class="card-top-img" src="assets/img/demo/20_img.jpg" alt="5 Tips for Sustainable Business Success">
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-top position-relative">
                                                <a title="Assessing the Maturity of Your Data Management in Industry" href="news-single-post.html">
                                                    <div class="img object-fit overflow-hidden">
                                                        <div class="object-fit-cover transform-scale-h">
                                                            <img class="card-top-img" src="assets/img/demo/21_img.jpg" alt="Assessing the Maturity of Your Data Management in Industry">
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="card card-post">
                                            <div class="card-top position-relative">
                                                <a title="How to Build Your Sustainable Susiness Strategy" href="news-single-post.html">
                                                    <div class="img object-fit overflow-hidden">
                                                        <div class="object-fit-cover transform-scale-h">
                                                            <img class="card-top-img" src="assets/img/demo/22_img.jpg" alt="How to Build Your Sustainable Susiness Strategy">
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                ...
                                <div class="row gutter-width-md with-pb-md">
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="contacts-item">
                                            ...
                                            <p class="contacts-item-description">90 Green Field, Pakhowal Road, <br>Ludhiana (141001), <br>India</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="contacts-item">
                                            ...
                                            <p class="contacts-item-description">
                                                Mobile: <a href="tel:+91 9646125737">+91 9646125737</a><br>
                                    ...
                                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                        <div class="contacts-item">
                                            ...
                                            <p class="contacts-item-description">
                                                 <a href="mailto:vastu@tathaastu.life">vastu@tathaastu.life</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="contact-form">
                                    ...
                                    <div class="spacer p-top-lg">
                                        <form method="post" action="form.php" id="cf-1" class="contact-form">
                                            ...
                                            <div class="form-group form-group-xs">
                                                <input name="cf-1-subject" type="text" class="form-control form-control-lg bg-gray-light" id="cf-1-subject" placeholder="Subject" required="required">
                                            </div>
