!function(e, t) {
    ...
    function w(e, t, i) {
        var n, r, a = (i = i || T).createElement("script");
        if (a.text = e,
        t)
            for (n in u)
    ...
    E.extend = E.fn.extend = function() {
        var e, t, i, n, r, a = arguments[0] || {}, s = 1, o = arguments.length, l = !1;
        ...
        s--); s < o; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    i = e[t],
                    "__proto__" !== t && a !== i && (l && i && (E.isPlainObject(i) || (n = Array.isArray(i))) ? (r = a[t],
                    r = n && !Array.isArray(r) ? [] : n || E.isPlainObject(r) ? r : {},
                    n = !1,
                    a[t] = E.extend(l, r, i)) : void 0 !== i && (a[t] = i));
        return a
    }
    ,
    E.extend({
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (h(Object(e)) ? E.merge(t, "string" == typeof e ? [e] : e) : l.call(t, e)),
            t
        },
    ...
    var p = function(i) {
        ...
        var e, p, w, a, r, f, h, m, x, l, d, C, T, s, E, g, o, u, v, S = "sizzle" + +new Date, y = i.document, _ = 0, b = 0, k = le(), M = le(), D = le(), I = le(), O = function(e, t) {
            return e === t && (d = !0),
            0
        }, L = {}.hasOwnProperty, t = [], A = t.pop, P = t.push, N = t.push, z = t.slice, B = function(e, t) {
            for (var i = 0, n = e.length; i < n; i++)
                if (e[i] === t)
                    return i;
            return -1
        }, j = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\[\\da-fA-F]{1,6}" + H + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", $ = "\\[" + H + "*(" + R + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + H + "*\\]", q = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", W = new RegExp(H + "+","g"), F = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), V = new RegExp("^" + H + "*," + H + "*"), Y = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), X = new RegExp(H + "|>"), G = new RegExp(q), U = new RegExp("^" + R + "$"), Q = {
            ID: new RegExp("^#(" + R + ")"),
            CLASS: new RegExp("^\\.(" + R + ")"),
            TAG: new RegExp("^(" + R + "|[*])"),
            ATTR: new RegExp("^" + $),
        ...
        }, K = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ie = /[+~]/, ne = new RegExp("\\\\[\\da-fA-F]{1,6}" + H + "?|\\\\([^\\r\\n\\f])","g"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ae = function(e, t) {
        ...
        try {
            N.apply(t = z.call(y.childNodes), y.childNodes),
        ...
        function oe(t, e, i, n) {
            var r, a, s, o, l, d, u, c = e && e.ownerDocument, h = e ? e.nodeType : 9;
            if (i = i || [],
                    ...
                    if (r = l[1]) {
                        if (9 === h) {
                            ...
                            if (s.id === r)
                                return i.push(s),
                                i
                        } else if (c && (s = c.getElementById(r)) && v(e, s) && s.id === r)
                            return i.push(s),
                            i
                    } else {
                        if (l[2])
                        ...
                        if ((r = l[3]) && p.getElementsByClassName && e.getElementsByClassName)
                            return N.apply(i, e.getElementsByClassName(r)),
                            i
                    }
                if (p.qsa && !I[t + " "] && (!g || !g.test(t)) && (1 !== h || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t,
                    c = e,
                    1 === h && (X.test(t) || Y.test(t))) {
                        for ((c = ie.test(t) && me(e.parentNode) || e) === e && p.scope || ((o = e.getAttribute("id")) ? o = o.replace(re, ae) : e.setAttribute("id", o = S)),
                        a = (d = f(t)).length; a--; )
                            d[a] = (o ? "#" + o : ":scope") + " " + ve(d[a]);
                        u = d.join(",")
                    }
                    try {
                        return N.apply(i, c.querySelectorAll(u)),
                        i
                    } catch (e) {
                        I(t, !0)
                    } finally {
        ...
        function le() {
            var i = [];
            function n(e, t) {
                return i.push(e + " ") > w.cacheLength && delete n[i.shift()],
                n[e + " "] = t
            }
            return n
        }
        ...
        C = oe.setDocument = function(e) {
            ...
            return e != T && 9 === e.nodeType && e.documentElement && (s = (T = e).documentElement,
            E = !r(T),
            ...
            o = [],
            g = [],
            (p.qsa = ee.test(T.querySelectorAll)) && (ue(function(e) {
                var t;
            ...
            O = t ? function(e, t) {
                ...
                return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === i ? e == T || e.ownerDocument == y && v(y, e) ? -1 : t == T || t.ownerDocument == y && v(y, t) ? 1 : l ? B(l, e) - B(l, t) : 0 : 4 & i ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return d = !0,
                ...
                if (!r || !a)
                    return e == T ? -1 : t == T ? 1 : r ? -1 : a ? 1 : l ? B(l, e) - B(l, t) : 0;
                if (r === a)
                    return he(e, t);
        ...
        oe.matchesSelector = function(e, t) {
            if (C(e),
            p.matchesSelector && E && !I[t + " "] && (!o || !o.test(t)) && (!g || !g.test(t)))
                try {
                    var i = u.call(e, t);
        ...
        oe.attr = function(e, t) {
            ...
            var i = w.attrHandle[t.toLowerCase()]
              , i = i && L.call(w.attrHandle, t.toLowerCase()) ? i(e, t, !E) : void 0;
        ...
        (w = oe.selectors = {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(ne, c),
                    e[3] = (e[3] || e[4] || e[5] || "").replace(ne, c),
                    "~=" === e[2] && (e[3] = " " + e[3] + " "),
                    e.slice(0, 4)
                },
                CHILD: function(e) {
                ...
                PSEUDO: function(e) {
                    var t, i = !e[6] && e[2];
                    return Q.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : i && G.test(i) && (t = f(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t),
                    e[2] = i.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(t, i, n) {
                    return function(e) {
                        e = oe.attr(e, t);
                        return null == e ? "!=" === i : !i || (e += "",
                        "=" === i ? e === n : "!=" === i ? e !== n : "^=" === i ? n && 0 === e.indexOf(n) : "*=" === i ? n && -1 < e.indexOf(n) : "$=" === i ? n && e.slice(-n.length) === n : "~=" === i ? -1 < (" " + e.replace(W, " ") + " ").indexOf(n) : "|=" === i && (e === n || e.slice(0, n.length + 1) === n + "-"))
                    }
                },
                CHILD: function(f, e, t, m, g) {
                    ...
                    : function(e, t, i) {
                        var n, r, a, s, o, l, d = v != y ? "nextSibling" : "previousSibling", u = e.parentNode, c = b && e.nodeName.toLowerCase(), h = !i && !b, p = !1;
                        if (u) {
                            if (v) {
                                for (; d; ) {
                                    for (s = e; s = s[d]; )
                            ...
                            y && h) {
                                for (p = (o = (n = (r = (a = (s = u)[S] || (s[S] = {}))[s.uniqueID] || (a[s.uniqueID] = {}))[f] || [])[0] === _ && n[1]) && n[2],
                                s = o && u.childNodes[o]; s = ++o && s && s[d] || (p = o = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++p && s === e) {
                                        r[f] = [_, o, p];
                                        break
                                    }
                            } else if (h && (p = o = (n = (r = (a = (s = e)[S] || (s[S] = {}))[s.uniqueID] || (a[s.uniqueID] = {}))[f] || [])[0] === _ && n[1]),
                            !1 === p)
                                for (; (s = ++o && s && s[d] || (p = o = 0) || l.pop()) && ((b ? s.nodeName.toLowerCase() !== c : 1 !== s.nodeType) || !++p || (h && ((r = (a = s[S] || (s[S] = {}))[s.uniqueID] || (a[s.uniqueID] = {}))[f] = [_, p]),
                                s !== e)); )
                                    ;
                ...
                PSEUDO: function(e, a) {
                    ...
                    w.setFilters.hasOwnProperty(e.toLowerCase()) ? de(function(e, t) {
            ...
            pseudos: {
                ...
                lang: de(function(i) {
                    return U.test(i || "") || oe.error("unsupported lang: " + i),
        ...
        function ye(s, e, t) {
            ...
            : function(e, t, i) {
                ...
                if (i) {
                    for (; e = e[o]; )
                        if ((1 === e.nodeType || u) && s(e, t, i))
                            return !0
                } else
                    for (; e = e[o]; )
                        if (1 === e.nodeType || u)
                            if (n = (r = e[S] || (e[S] = {}))[e.uniqueID] || (r[e.uniqueID] = {}),
                            l && l === e.nodeName.toLowerCase())
                                e = e[o] || e;
                            else {
                                if ((r = n[d]) && r[0] === _ && r[1] === c)
                                    return a[2] = r[2];
                                if ((n[d] = a)[2] = s(e, t, i))
                                    return !0
                            }
            ...
            de(function(e, t, i, n) {
                var r, a, s, o = [], l = [], d = t.length, u = e || function(e, t, i) {
                    for (var n = 0, r = t.length; n < r; n++)
                        oe(e, t[n], i);
                    return i
                }(f || "*", i.nodeType ? [i] : i, []), c = !p || !e && f ? u : we(u, o, p, i, n), h = m ? v || (e ? p : d || g) ? [] : t : c;
                if (m && m(c, h, i, n),
                g)
                    for (r = we(h, l),
                    g(r, [], i, n),
                ...
                if (e) {
                    if (v || p) {
                        ...
                        for (a = h.length; a--; )
                            (s = h[a]) && -1 < (r = v ? B(e, s) : o[a]) && (e[r] = !(t[r] = s))
                    }
                } else
                    h = we(h === t ? h.splice(d, h.length) : h),
                    v ? v(null, t, h, n) : N.apply(t, h)
            })
        }
        function Ce(g, v) {
            function e(e, t, i, n, r) {
                var a, s, o, l = 0, d = "0", u = e && [], c = [], h = x, p = e || b && w.find.TAG("*", r), f = _ += null == h ? 1 : Math.random() || .1, m = p.length;
                for (r && (x = t == T || t || r); d !== m && null != (a = p[d]); d++) {
                    if (b && a) {
                        for (s = 0,
                        t || a.ownerDocument == T || (C(a),
                        i = !E); o = g[s++]; )
                            if (o(a, t || T, i)) {
                                n.push(a);
                                break
                ...
                y && d !== l) {
                    ...
                    N.apply(n, c),
                    r && !e && 0 < c.length && 1 < l + v.length && oe.uniqueSort(n)
                }
                return r && (_ = f,
                x = h),
                u
        ...
        f = oe.tokenize = function(e, t) {
            var i, n, r, a, s, o, l, d = M[e + " "];
            if (d)
                return t ? 0 : d.slice(0);
            for (s = e,
            o = [],
            l = w.preFilter; s; ) {
                for (a in i && !(n = V.exec(s)) || (n && (s = s.slice(n[0].length) || s),
                o.push(r = [])),
                i = !1,
                (n = Y.exec(s)) && (i = n.shift(),
                r.push({
                    value: i,
                    type: n[0].replace(F, " ")
                }),
                s = s.slice(i.length)),
                w.filter)
                    !(n = Q[a].exec(s)) || l[a] && !(n = l[a](n)) || (i = n.shift(),
                    r.push({
                        value: i,
                        type: a,
                        matches: n
        ...
        h = oe.compile = function(e, t) {
            ...
            if (!a) {
                for (i = (t = t || f(e)).length; i--; )
                    ((a = function e(t) {
                        for (var n, i, r, a = t.length, s = w.relative[t[0].type], o = s || w.relative[" "], l = s ? 1 : 0, d = ye(function(e) {
                            return e === n
                        }, o, !0), u = ye(function(e) {
                            return -1 < B(n, e)
                        }, o, !0), c = [function(e, t, i) {
                            return i = !s && (i || t !== x) || ((n = t).nodeType ? d : u)(e, t, i),
                            n = null,
                            i
                        }
                        ]; l < a; l++)
                            if (i = w.relative[t[l].type])
                                c = [ye(be(c), i)];
                            else {
                                if ((i = w.filter[t[l].type].apply(null, t[l].matches))[S]) {
                                    for (r = ++l; r < a && !w.relative[t[r].type]; r++)
                                        ;
                                    return xe(1 < l && be(c), 1 < l && ve(t.slice(0, l - 1).concat({
                                        value: " " === t[l - 2].type ? "*" : ""
                                    })).replace(F, "$1"), i, l < r && e(t.slice(l, r)), r < a && e(t = t.slice(r)), r < a && ve(t))
                                }
                                c.push(i)
                            }
                        return be(c)
        ...
        m = oe.select = function(e, t, i, n) {
            ...
            1 === u.length) {
                if (2 < (a = u[0] = u[0].slice(0)).length && "ID" === (s = a[0]).type && 9 === t.nodeType && E && w.relative[a[1].type]) {
                    if (!(t = (w.find.ID(s.matches[0].replace(ne, c), t) || [])[0]))
                        return i;
                    d && (t = t.parentNode),
            ...
            return (d || h(e, u))(n, t, !E, i, !t || ie.test(e) && me(t.parentNode) || t),
            i
        }
        ,
        p.sortStable = S.split("").sort(O).join("") === S,
    ...
    (E.fn.init = function(e, t, i) {
        ...
        "string" != typeof e)
            ...
            this.length = 1,
            this) : b(e) ? void 0 !== i.ready ? i.ready(e) : e(E) : E.makeArray(e, this);
        ...
        if (n[1]) {
            ...
            M.test(n[1]) && E.isPlainObject(t))
                for (var n in t)
                    b(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
            return this
        }
        return (e = T.getElementById(n[2])) && (this[0] = e,
        this.length = 1),
        this
    }
    ).prototype = E.fn,
    ...
    E.fn.extend({
        ...
        closest: function(e, t) {
            var i, n = 0, r = this.length, a = [], s = "string" != typeof e && E(e);
            if (!_.test(e))
                for (; n < r; n++)
    ...
    E.each({
        ...
        E.fn[n] = function(e, t) {
            ...
            1 < this.length && (A[n] || E.uniqueSort(i),
            L.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    E.extend({
              ...
              , s = {
                ...
                then: function(t, i, n) {
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    b(t) ? o ? t.call(e, d(l, a, z, o), d(l, a, B, o)) : (l++,
                                    t.call(e, d(l, a, z, o), d(l, a, B, o), d(l, a, z, a.notifyWith))) : (s !== z && (i = void 0,
                                    n = [e]),
                                    (o || a.resolveWith)(i, n))
                                }
                            }
                    ...
                    return E.Deferred(function(e) {
                        a[0][3].add(d(0, e, b(n) ? n : z, e.notifyWith)),
                        a[1][3].add(d(0, e, b(t) ? t : z)),
                        a[2][3].add(d(0, e, b(i) ? i : B))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            var i = arguments.length
              ...
              , a = o.call(arguments)
              , s = E.Deferred();
            if (i <= 1 && (j(e, s.done(t(n)).resolve, s.reject, !i),
            "pending" === s.state() || b(a[n] && a[n].then)))
                return s.then();
            for (; n--; )
                j(a[n], t(n), s.reject);
            return s.promise()
    ...
    E.ready.then = R.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? C.setTimeout(E.ready) : (T.addEventListener("DOMContentLoaded", $),
        ...
        data: function(i, e) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var t;
                    return a && void 0 === e ? void 0 !== (t = Q.get(a, i)) || void 0 !== (t = Z(a, i)) ? t : void 0 : void this.each(function() {
                        Q.set(this, i, e)
                    })
            ...
            1 === a.nodeType && !U.get(a, "hasDataAttrs"))) {
                for (t = s.length; t--; )
                    s[t] && 0 === (n = s[t].name).indexOf("data-") && (n = Y(n.slice(5)),
                    Z(a, n, r[n]));
    ...
    E.extend({
        queue: function(e, t, i) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                n = U.get(e, t),
                i && (!n || Array.isArray(i) ? n = U.access(e, t, E.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    E.fn.extend({
        ...
        promise: function(e, t) {
            ...
            var n, r = 1, a = E.Deferred(), s = this, o = this.length;
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; o--; )
                (n = U.get(s[o], e + "queueHooks")) && n.empty && (r++,
                n.empty.add(i));
            return i(),
            a.promise(t)
        }
    ...
    function oe(e, t, i, n) {
        ...
        , l = o(), d = i && i[3] || (E.cssNumber[t] ? "" : "px"), u = e.nodeType && (E.cssNumber[t] || "px" !== d && +l) && te.exec(E.css(e, t));
        if (u && u[3] !== d) {
            for (l /= 2,
            d = d || u[3],
            u = +l || 1; s--; )
    ...
    function de(e, t) {
        for (var i, n, r, a, s, o = [], l = 0, d = e.length; l < d; l++)
            ...
            t ? ("none" === i && (o[l] = U.get(n, "display") || null,
            o[l] || (n.style.display = "")),
            "" === n.style.display && se(n) && (o[l] = (s = a = void 0,
            a = (r = n).ownerDocument,
            s = r.nodeName,
            (r = le[s]) || (a = a.body.appendChild(a.createElement(s)),
            r = E.css(a, "display"),
            a.parentNode.removeChild(a),
            "none" === r && (r = "block"),
            le[s] = r)))) : "none" !== i && (o[l] = "none",
            U.set(n, "display", i)));
        for (l = 0; l < d; l++)
    ...
    function ve(e, t, i, n, r) {
        for (var a, s, o, l, d, u = t.createDocumentFragment(), c = [], h = 0, p = e.length; h < p; h++)
            if ((a = e[h]) || 0 === a)
                if ("object" === f(a))
                    ...
                    o = pe[o] || pe._default,
                    s.innerHTML = o[1] + E.htmlPrefilter(a) + o[2],
                    d = o[0]; d--; )
                        s = s.lastChild;
                    E.merge(c, s.childNodes),
        ...
        h = 0; a = c[h++]; )
            ...
            s = fe(u.appendChild(a), "script"),
            l && me(s),
            i)
                for (d = 0; a = s[d++]; )
                    he.test(a.type || "") && i.push(a);
        return u
    }
    var ye = /^key/
        ...
        E.event.add(e, r, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    ...
                    t = a(this, r),
                    this[r](),
                    n !== (i = U.get(this, r)) || t ? U.set(this, r, !1) : i = {},
                    n !== i)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        i.value
                } else
                    n.length && (U.set(this, r, {
    ...
    E.event = {
        ...
        add: function(t, e, i, n, r) {
            var a, s, o, l, d, u, c, h, p, f = U.get(t);
            if (X(t))
                ...
                (s = f.handle) || (s = f.handle = function(e) {
                ...
                l = (e = (e || "").match(N) || [""]).length; l--; )
                    ...
                    (p = o[c]) || ((p = o[c] = []).delegateCount = 0,
                    u.setup && !1 !== u.setup.call(t, n, h, s) || t.addEventListener && t.addEventListener(c, s)),
        ...
        remove: function(e, t, i, n, r) {
            var a, s, o, l, d, u, c, h, p, f, m, g = U.hasData(e) && U.get(e);
            if (g && (l = g.events)) {
                for (d = (t = (t || "").match(N) || [""]).length; d--; )
                    if (p = m = (o = we.exec(t[d]) || [])[1],
                    f = (o[2] || "").split(".").sort(),
                    p) {
                        ...
                        s && !h.length && (c.teardown && !1 !== c.teardown.call(e, f, g.handle) || E.removeEvent(e, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(e) {
            var t, i, n, r, a, s = new Array(arguments.length), o = E.event.fix(e), l = (U.get(this, "events") || Object.create(null))[o.type] || [], e = E.event.special[o.type] || {};
            for (s[0] = o,
            t = 1; t < arguments.length; t++)
                s[t] = arguments[t];
            if (o.delegateTarget = this,
            !e.preDispatch || !1 !== e.preDispatch.call(this, o)) {
                for (a = E.event.handlers.call(this, o, l),
                t = 0; (n = a[t++]) && !o.isPropagationStopped(); )
                    for (o.currentTarget = n.elem,
                    i = 0; (r = n.handlers[i++]) && !o.isImmediatePropagationStopped(); )
                        o.rnamespace && !1 !== r.namespace && !o.rnamespace.test(r.namespace) || (o.handleObj = r,
                        o.data = r.data,
                        void 0 !== (r = ((E.event.special[r.origType] || {}).handle || r.handler).apply(n.elem, s)) && !1 === (o.result = r) && (o.preventDefault(),
                        o.stopPropagation()));
                return e.postDispatch && e.postDispatch.call(this, o),
                o.result
            }
        },
            ...
            if (l && d.nodeType && !("click" === e.type && 1 <= e.button))
                for (; d !== this; d = d.parentNode || this)
                    if (1 === d.nodeType && ("click" !== e.type || !0 !== d.disabled)) {
                        ...
                        s = {},
                        i = 0; i < l; i++)
                            void 0 === s[r = (n = t[i]).selector + " "] && (s[r] = n.needsContext ? -1 < E(r, this).index(d) : E.find(r, this, null, [d]).length),
                            s[r] && a.push(n);
                        a.length && o.push({
                            elem: d,
                            handlers: a
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return ue.test(e.type) && e.click && k(e, "input") && Se(e, "click", xe),
                    !1
                },
                trigger: function(e) {
                    e = this || e;
                    return ue.test(e.type) && e.click && k(e, "input") && Se(e, "click"),
                    !0
                },
                _default: function(e) {
                    e = e.target;
    ...
    function Ae(i, n, r, a) {
        n = g(n);
        var e, t, s, o, l, d, u = 0, c = i.length, h = c - 1, p = n[0], f = b(p);
        ...
        if (c && (t = (e = ve(n, i[0].ownerDocument, !1, i, a)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || a)) {
            for (o = (s = E.map(fe(e, "script"), Ie)).length; u < c; u++)
                l = e,
                u !== h && (l = E.clone(l, !0, !0),
                o && E.merge(s, fe(l, "script"))),
                r.call(i[u], l, u);
            if (o)
                ...
                u = 0; u < o; u++)
                    l = s[u],
                    he.test(l.type || "") && !U.access(l, "globalEval") && E.contains(d, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, {
    ...
    function Pe(e, t, i) {
        for (var n, r = t ? E.filter(t, e) : e, a = 0; null != (n = r[a]); a++)
            i || 1 !== n.nodeType || E.cleanData(fe(n)),
            n.parentNode && (i && re(n) && me(fe(n, "script")),
    ...
    E.extend({
        ...
        clone: function(e, t, i) {
            var n, r, a, s, o, l, d, u = e.cloneNode(!0), c = re(e);
            if (!(y.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e)))
                for (s = fe(u),
                n = 0,
                r = (a = fe(e)).length; n < r; n++)
                    o = a[n],
                    l = s[n],
                    d = void 0,
                    "input" === (d = l.nodeName.toLowerCase()) && ue.test(o.type) ? l.checked = o.checked : "input" !== d && "textarea" !== d || (l.defaultValue = o.defaultValue);
            if (t)
                if (i)
                    for (a = a || fe(e),
                    s = s || fe(u),
                    ...
                    Le(e, u);
            return 0 < (s = fe(u, "script")).length && me(s, !c && fe(e, "script")),
            u
        },
    ...
    E.fn.extend({
        ...
        html: function(e) {
            return q(this, function(e) {
                ...
                if ("string" == typeof e && !_e.test(e) && !pe[(ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (t = this[i] || {}).nodeType && (E.cleanData(fe(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Ae(this, arguments, function(e) {
                ...
                E.inArray(this, i) < 0 && (E.cleanData(fe(this)),
    ...
    E.each({
        ...
        E.fn[e] = function(e) {
            for (var t, i = [], n = E(e), r = n.length - 1, a = 0; a <= r; a++)
    ...
    var ze, Be, je, He, Re, $e, qe, We, Fe = new RegExp("^(" + ee + ")(?!px)[a-z%]+$","i"), Ve = function(e) {
    ...
    function Xe() {
        var e;
        We && (qe.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
        ...
        ze = "1%" !== e.top,
        $e = 12 === Ge(e.marginLeft),
        We.style.right = "60%",
        He = 36 === Ge(e.right),
        Be = 36 === Ge(e.width),
        We.style.position = "absolute",
        je = 12 === Ge(We.offsetWidth / 3),
        ne.removeChild(qe),
        We = null)
    }
    function Ge(e) {
    ...
    function Ue(e, t, i) {
        var n, r, a = e.style;
        return (i = i || Ve(e)) && ("" !== (r = i.getPropertyValue(t) || i[t]) || re(e) || (r = E.style(e, t)),
        !y.pixelBoxStyles() && Fe.test(r) && Ye.test(t) && (n = a.width,
        e = a.minWidth,
        t = a.maxWidth,
    ...
    E.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e, t, i;
            return null == Re && (e = T.createElement("table"),
    ...
    function st(e, t, i, n, r, a) {
        ...
        for (; s < 4; s += 2)
            ...
            n ? ("content" === i && (l -= E.css(e, "padding" + ie[s], !0, r)),
            "margin" !== i && (l -= E.css(e, "border" + ie[s] + "Width", !0, r))) : (l += E.css(e, "padding" + ie[s], !0, r),
            "padding" !== i ? l += E.css(e, "border" + ie[s] + "Width", !0, r) : o += E.css(e, "border" + ie[s] + "Width", !0, r));
        return !n && 0 <= a && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - a - l - o - .5)) || 0),
        l
    }
    function ot(e, t, i) {
        var n = Ve(e)
        ...
        return (!y.boxSizingReliable() && r || !y.reliableTrDimensions() && k(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === E.css(e, "display", !1, n)) && e.getClientRects().length && (r = "border-box" === E.css(e, "boxSizing", !1, n),
        (a = o in e) && (s = e[o])),
    ...
    E.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, a, s, o = Y(t), l = it.test(t), d = e.style;
                if (l || (t = et(o)),
                s = E.cssHooks[t] || E.cssHooks[o],
                void 0 === i)
                    return s && "get"in s && void 0 !== (r = s.get(e, !1, n)) ? r : d[t];
                "string" === (a = typeof i) && (r = te.exec(i)) && r[1] && (i = oe(e, t, r),
                a = "number"),
                null != i && i == i && ("number" !== a || l || (i += r && r[3] || (E.cssNumber[o] ? "" : "px")),
        ...
        css: function(e, t, i, n) {
            var r, a = Y(t);
            return it.test(t) || (t = et(a)),
            (a = E.cssHooks[t] || E.cssHooks[a]) && "get"in a && (r = a.get(e, !0, i)),
            void 0 === r && (r = Ue(e, t, n)),
            "normal" === r && t in rt && (r = rt[t]),
            "" === i || i ? (t = parseFloat(r),
            !0 === i || isFinite(t) ? t || 0 : r) : r
        }
    }),
    E.each(["height", "width"], function(e, o) {
        E.cssHooks[o] = {
            get: function(e, t, i) {
                if (t)
                    return !tt.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ot(e, o, i) : Ne(e, nt, function() {
                        return ot(e, o, i)
                    })
            },
            set: function(e, t, i) {
                var n, r = Ve(e), a = !y.scrollboxSize() && "absolute" === r.position, s = (a || i) && "border-box" === E.css(e, "boxSizing", !1, r), i = i ? st(e, o, i, s, r) : 0;
                return s && a && (i -= Math.ceil(e["offset" + o[0].toUpperCase() + o.slice(1)] - parseFloat(r[o]) - st(e, o, "border", !1, r) - .5)),
                i && (n = te.exec(t)) && "px" !== (n[3] || "px") && (e.style[o] = t,
                t = E.css(e, o)),
                at(0, t, i)
            }
        }
    ...
    E.fx.step = {};
    var dt, ut, ct = /^(?:toggle|show|hide)$/, ht = /queueHooks$/;
    function pt() {
        ut && (!1 === T.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(pt) : C.setTimeout(pt, E.fx.interval),
        E.fx.tick())
    }
    function ft() {
    ...
    function gt(e, t, i) {
        for (var n, r = (vt.tweeners[t] || []).concat(vt.tweeners["*"]), a = 0, s = r.length; a < s; a++)
            if (n = r[a].call(i, t, e))
                return n
    }
    function vt(r, e, t) {
        var i, a, n = 0, s = vt.prefilters.length, o = E.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (a)
                return !1;
            for (var e = dt || ft(), e = Math.max(0, d.startTime + d.duration - e), t = 1 - (e / d.duration || 0), i = 0, n = d.tweens.length; i < n; i++)
                d.tweens[i].run(t);
            return o.notifyWith(r, [d, t, e]),
            t < 1 && n ? e : (n || o.notifyWith(r, [d, 1, 0]),
            o.resolveWith(r, [d]),
            !1)
        }, d = o.promise({
            elem: r,
            ...
            stop: function(e) {
                ...
                for (a = !0; t < i; t++)
                    d.tweens[t].run(1);
                return e ? (o.notifyWith(r, [d, 1, 0]),
                o.resolveWith(r, [d, e])) : o.rejectWith(r, [d, e]),
                this
            }
        }), u = d.props;
        for (!function(e, t) {
            ...
            if (i = vt.prefilters[n].call(d, r, u, d.opts))
                return b(i.stop) && (E._queueHooks(d.elem, d.opts.queue).stop = i.stop.bind(i)),
                i;
        return E.map(u, gt, d),
    ...
    E.Animation = E.extend(vt, {
        ...
        tweener: function(e, t) {
            for (var i, n = 0, r = (e = b(e) ? (t = e,
            ["*"]) : e.match(N)).length; n < r; n++)
                i = e[n],
                vt.tweeners[i] = vt.tweeners[i] || [],
                vt.tweeners[i].unshift(t)
        },
        prefilters: [function(e, t, i) {
            var n, r, a, s, o, l, d, u = "width"in t || "height"in t, c = this, h = {}, p = e.style, f = e.nodeType && se(e), m = U.get(e, "fxshow");
            ...
            if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(h))
                ...
                "none" === (u = E.css(e, "display")) && (d ? u = d : (de([e], !0),
                d = e.style.display || d,
                u = E.css(e, "display"),
                de([e]))),
    ...
    E.fn.extend({
        ...
        animate: function(t, e, i, n) {
            ...
            return n.finish = n,
            r || !1 === a.queue ? this.each(n) : this.queue(a.queue, n)
        },
        stop: function(r, e, a) {
            function s(e) {
                var t = e.stop;
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var e, t = U.get(this), i = t[s + "queue"], n = t[s + "queueHooks"], r = E.timers, a = i ? i.length : 0;
                for (t.finish = !0,
                E.queue(this, s, []),
    ...
    E.extend({
        attr: function(e, t, i) {
            ...
            if (3 !== a && 8 !== a && 2 !== a)
                return void 0 === e.getAttribute ? E.prop(e, t, i) : (1 === a && E.isXMLDoc(e) || (r = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? yt : void 0)),
    ...
    E.fn.extend({
        val: function(t) {
            ...
            })) : r ? (i = E.valHooks[r.type] || E.valHooks[r.nodeName.toLowerCase()]) && "get"in i && void 0 !== (e = i.get(r, "value")) ? e : "string" == typeof (e = r.value) ? e.replace(St, "") : null == e ? "" : e : void 0
        }
    }),
    E.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var i, n, r = e.options, a = E.makeArray(t), s = r.length; s--; )
                        ((n = r[s]).selected = -1 < E.inArray(E.valHooks.option.get(n), a)) && (i = !0);
    ...
    E.extend(E.event, {
        trigger: function(e, t, i, n) {
            var r, a, s, o, l, d, u, c = [i || T], h = v.call(e, "type") ? e.type : e, p = v.call(e, "namespace") ? e.namespace.split(".") : [], f = u = a = i = i || T;
            if (3 !== i.nodeType && 8 !== i.nodeType && !kt.test(h + E.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(),
            p.sort()),
            o = h.indexOf(":") < 0 && "on" + h,
            ...
            n || !d.trigger || !1 !== d.trigger.apply(i, t))) {
                if (!n && !d.noBubble && !m(i)) {
                    for (s = d.delegateType || h,
                    kt.test(s + h) || (f = f.parentNode); f; f = f.parentNode)
                        c.push(f),
                        a = f;
                ...
                for (r = 0; (f = c[r++]) && !e.isPropagationStopped(); )
                    ...
                    (l = o && f[o]) && l.apply && X(f) && (e.result = l.apply(f, t),
                    !1 === e.result && e.preventDefault());
                return e.type = h,
                n || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(c.pop(), t) || !X(i) || o && b(i[h]) && !m(i) && ((a = i[o]) && (i[o] = null),
                E.event.triggered = h,
    ...
    y.focusin || E.each({
        ...
        E.event.special[n] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this.document || this
                  , t = U.access(e, n) - 1;
                t ? U.access(e, n, t) : (e.removeEventListener(i, r, !0),
                U.remove(e, n))
            }
        }
    });
        ...
        if (Array.isArray(e) || e.jquery && !E.isPlainObject(e))
            ...
            for (n in e)
                !function i(n, e, r, a) {
                    if (Array.isArray(e))
                        E.each(e, function(e, t) {
                            r || Ot.test(n) ? a(n, t) : i(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, r, a)
                        });
    ...
    E.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var l, d, u, i, c, n, h, p, r, f = E.ajaxSetup({}, t), m = f.context || f, g = f.context && (m.nodeType || m.jquery) ? E(m) : E.event, v = E.Deferred(), y = E.Callbacks("once memory"), b = f.statusCode || {}, a = {}, s = {}, o = "canceled", w = {
                readyState: 0,
            ...
            null == f.crossDomain) {
                ...
                try {
                    n.href = f.url,
                    n.href = n.href,
                    f.crossDomain = Ft.protocol + "//" + Ft.host != n.protocol + "//" + n.host
                } catch (e) {
                    f.crossDomain = !0
                }
            }
            ...
            d = f.url.replace(zt, ""),
            f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Nt, "+")) : (e = f.url.slice(d.length),
            f.data && (f.processData || "string" == typeof f.data) && (d += (It.test(d) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (d = d.replace(Bt, "$1"),
            e = (It.test(d) ? "&" : "?") + "_=" + Dt.guid++ + e),
            f.url = d + e),
            f.ifModified && (E.lastModified[d] && w.setRequestHeader("If-Modified-Since", E.lastModified[d]),
            ...
            function x(e, t, i, n) {
                ...
                n ? (f.ifModified && ((i = w.getResponseHeader("Last-Modified")) && (E.lastModified[d] = i),
                (i = w.getResponseHeader("etag")) && (E.etag[d] = i)),
                204 === e || "HEAD" === f.type ? o = "nocontent" : 304 === e ? o = "notmodified" : (o = s.state,
                r = s.data,
                n = !(a = s.error))) : (a = o,
                !e && o || (o = "error",
                e < 0 && (e = 0))),
                ...
                send: function(e, t) {
                    ...
                    a = function(e) {
                        return function() {
                            ...
                            "abort" === e ? n.abort() : "error" === e ? "number" != typeof n.status ? t(0, "error") : t(n.status, n.statusText) : t(Gt[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    E.ajaxPrefilter("json jsonp", function(e, t, i) {
        var n, r, a, s = !1 !== e.jsonp && (Kt.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Kt.test(e.data) && "data");
        if (s || "jsonp" === e.dataTypes[0])
            return n = e.jsonpCallback = b(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
    ...
    y.createHTMLDocument = ((c = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === c.childNodes.length),
    E.parseHTML = function(e, t, i) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (i = t,
        t = !1),
        t || (y.createHTMLDocument ? ((n = (t = T.implementation.createHTMLDocument("")).createElement("base")).href = T.location.href,
        t.head.appendChild(n)) : t = T),
        n = !i && [],
        (i = M.exec(e)) ? [t.createElement(i[1])] : (i = ve([e], t, n),
    ...
    E.fn.load = function(e, t, i) {
        ...
        0 < s.length && E.ajax({
            ...
            a = arguments,
            s.html(n ? E("<div>").append(E.parseHTML(e)).find(n) : e)
    ...
    E.offset = {
        setOffset: function(e, t, i) {
            var n, r, a, s, o = E.css(e, "position"), l = E(e), d = {};
            "static" === o && (e.style.position = "relative"),
            a = l.offset(),
            n = E.css(e, "top"),
            s = E.css(e, "left"),
            s = ("absolute" === o || "fixed" === o) && -1 < (n + s).indexOf("auto") ? (r = (o = l.position()).top,
            o.left) : (r = parseFloat(n) || 0,
            parseFloat(s) || 0),
            b(t) && (t = t.call(e, i, E.extend({}, a))),
    ...
    E.each({
        ...
        E.fn[t] = function(e) {
            return q(this, function(e, t, i) {
                var n;
                return m(e) ? n = e : 9 === e.nodeType && (n = e.defaultView),
                void 0 === i ? n ? n[r] : e[t] : void (n ? n.scrollTo(a ? n.pageXOffset : i, a ? i : n.pageYOffset) : e[t] = i)
    ...
    E.each({
        ...
        E.each({
            ...
            E.fn[a] = function(e, t) {
                ...
                return q(this, function(e, t, i) {
                    var n;
                    return m(e) ? 0 === a.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (n = e.documentElement,
                    Math.max(e.body["scroll" + s], n["scroll" + s], e.body["offset" + s], n["offset" + s], n["client" + s])) : void 0 === i ? E.css(e, t, r) : E.style(e, t, i, r)
                }, o, i ? e : void 0, i)
            }
        })
    }),
...
function(e, t) {
    ...
    function a(e) {
        var t = this
          , i = !1;
        return u.default(this).one(c.TRANSITION_END, function() {
            i = !0
        }),
        setTimeout(function() {
        ...
        typeCheckConfig: function(e, t, i) {
            for (var n in i)
                if (Object.prototype.hasOwnProperty.call(i, n)) {
                    var r = i[n]
                      , a = t[n]
                      , s = a && c.isElement(a) ? "element" : null == (s = a) ? "" + s : {}.toString.call(s).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var l = "alert"
      ...
      , f = function() {
        ...
        ,
        e.dispose = function() {
            u.default.removeData(this._element, d),
            this._element = null
        }
        ,
        e._getRootElement = function(e) {
            ...
            i = i || u.default(e).closest(".alert")[0]
        }
        ,
        ...
        e._removeElement = function(t) {
            ...
            u.default(t).hasClass("fade") ? (e = c.getTransitionDurationFromElement(t),
            u.default(t).one(c.TRANSITION_END, function(e) {
    ...
    var m = "button"
      ...
      , x = function() {
        ...
        return e.toggle = function() {
            var e, t = !0, i = !0, n = u.default(this._element).closest('[data-toggle="buttons"]')[0];
            !n || (e = this._element.querySelector(w)) && ("radio" === e.type && (e.checked && this._element.classList.contains(b) ? t = !1 : (n = n.querySelector(".active")) && u.default(n).removeClass(b)),
            t && ("checkbox" !== e.type && "radio" !== e.type || (e.checked = !this._element.classList.contains(b)),
    ...
    u.default(document).on("click.bs.button.data-api", h, function(e) {
        var t, i = e.target, n = i;
        u.default(i).hasClass("btn") || (i = u.default(i).closest(".btn")[0]),
        !i || i.hasAttribute("disabled") || i.classList.contains("disabled") || (t = i.querySelector(w)) && (t.hasAttribute("disabled") || t.classList.contains("disabled")) ? e.preventDefault() : "INPUT" !== n.tagName && "LABEL" === i.tagName || x._jQueryInterface.call(u.default(i), "toggle", "INPUT" === n.tagName)
    ...
    var C = "carousel"
      ...
      , P = function() {
        ...
        e._getItemByDirection = function(e, t) {
            ...
            if ((n && 0 === r || i && r === a) && !this._config.wrap)
                return t;
        ...
        e._triggerSlideEvent = function(e, t) {
            ...
            return u.default(this._element).trigger(i),
            i
        }
        ,
        e._setActiveIndicatorElement = function(e) {
            ...
            u.default(t).removeClass(O),
            (e = this._indicatorsElement.children[this._getItemIndex(e)]) && u.default(e).addClass(O))
        }
        ,
        e._slide = function(e, t) {
            var i, n, r, a = this, s = this._element.querySelector(L), o = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), d = this._getItemIndex(l), t = Boolean(this._interval), e = e === M ? (i = "carousel-item-left",
            n = "carousel-item-next",
            "left") : (i = "carousel-item-right",
            n = "carousel-item-prev",
            "right");
            l && u.default(l).hasClass(O) ? this._isSliding = !1 : this._triggerSlideEvent(l, e).isDefaultPrevented() || s && l && (this._isSliding = !0,
            t && this.pause(),
            ...
            u.default(this._element).hasClass("slide") ? (u.default(l).addClass(n),
            c.reflow(l),
            u.default(s).addClass(i),
            u.default(l).addClass(i),
            (d = parseInt(l.getAttribute("data-interval"), 10)) ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
            ...
            u.default(s).one(c.TRANSITION_END, function() {
                u.default(l).removeClass(i + " " + n).addClass(O),
                u.default(s).removeClass(O + " " + n + " " + i),
                a._isSliding = !1,
                setTimeout(function() {
                    return u.default(a._element).trigger(r)
                }, 0)
            }).emulateTransitionEnd(d)) : (u.default(s).removeClass(O),
            u.default(l).addClass(O),
            this._isSliding = !1,
        ...
        r._dataApiClickHandler = function(e) {
            var t, i, n = c.getSelectorFromElement(this);
            !n || (t = u.default(n)[0]) && u.default(t).hasClass("carousel") && (i = o({}, u.default(t).data(), u.default(this).data()),
    ...
    var N = "collapse"
      ...
      , V = function() {
        ...
        e.show = function() {
            var e, t, i, n, r = this;
            this._isTransitioning || u.default(this._element).hasClass(R) || (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                return "string" == typeof r._config.parent ? e.getAttribute("data-parent") === r._config.parent : e.classList.contains($)
            })).length && (n = null),
            n && (i = u.default(n).not(this._selector).data(z)) && i._isTransitioning || (e = u.default.Event("show.bs.collapse"),
            u.default(this._element).trigger(e),
            e.isDefaultPrevented() || (n && (a._jQueryInterface.call(u.default(n).not(this._selector), "hide"),
            i || u.default(n).data(z, null)),
            ...
            u.default(this._element).one(c.TRANSITION_END, function() {
                u.default(r._element).removeClass(q).addClass($ + " " + R),
                r._element.style[t] = "",
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && u.default(this._element).hasClass(R)) {
                ...
                !t.isDefaultPrevented()) {
                    ...
                    u.default(this._element).addClass(q).removeClass($ + " " + R);
                    ...
                    u.default(this._element).one(c.TRANSITION_END, function() {
                        ...
                        u.default(e._element).removeClass(q).addClass($).trigger("hidden.bs.collapse")
        ...
        ,
        e._getConfig = function(e) {
            return (e = o({}, j, e)).toggle = Boolean(e.toggle),
            c.typeCheckConfig(N, e, H),
            e
        }
        ,
        ...
        a._jQueryInterface = function(n) {
            return this.each(function() {
                ...
                if (!t && i.toggle && "string" == typeof n && /show|hide/.test(n) && (i.toggle = !1),
                t || (t = new a(this,i),
                e.data(z, t)),
                "string" == typeof n) {
                    if (void 0 === t[n])
    ...
    u.default.fn[N] = V._jQueryInterface,
    u.default.fn[N].Constructor = V,
    u.default.fn[N].noConflict = function() {
        return u.default.fn[N] = B,
        V._jQueryInterface
    }
    ;
    var Y = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator
      , X = function() {
        for (var e = ["Edge", "Trident", "Firefox"], t = 0; t < e.length; t += 1)
            if (Y && 0 <= navigator.userAgent.indexOf(e[t]))
                return 1;
        return 0
    }();
    var G = Y && window.Promise ? function(e) {
        var t = !1;
        return function() {
            t || (t = !0,
    ...
    var ee = Y && !(!window.MSInputMethodContext || !document.documentMode)
      , te = Y && /MSIE 10/.test(navigator.userAgent);
    function ie(e) {
    ...
    function ne(e) {
        ...
        for (var t = ie(10) ? document.body : null, i = e.offsetParent || null; i === t && e.nextElementSibling; )
    ...
    function ae(e, t) {
        ...
        if (e !== i && t !== i || n.contains(r))
            return "BODY" === (r = (n = i).nodeName) || "HTML" !== r && ne(n.firstElementChild) !== n ? ne(i) : i;
        i = re(e);
    ...
    function le(e, t, i, n) {
        return Math.max(t["offset" + e], t["scroll" + e], i["client" + e], i["offset" + e], i["scroll" + e], ie(10) ? parseInt(i["offset" + e]) + parseInt(n["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }
    function de(e) {
        var t = e.body
          , i = e.documentElement
        ...
        return {
            height: le("Height", t, i, e),
            width: le("Width", t, i, e)
        }
    }
    var ue = function(e, t) {
        if (!(e instanceof t))
    ...
    function me(e) {
        var t, i, n = {};
        try {
            ie(10) ? (n = e.getBoundingClientRect(),
            t = se(e, "top"),
            i = se(e, "left"),
            n.top += t,
            n.left += i,
            n.bottom += t,
            n.right += i) : n = e.getBoundingClientRect()
        } catch (e) {}
        var r = {
            left: n.left,
            top: n.top,
    ...
    function ge(e, t, i) {
        ...
        n && a && (o.top = Math.max(o.top, 0),
        o.left = Math.max(o.left, 0));
        s = fe({
            top: s.top - o.top - i,
            left: s.left - o.left - e,
            width: s.width,
            height: s.height
        });
        return s.marginTop = 0,
        s.marginLeft = 0,
        !r && a && (a = parseFloat(d.marginTop),
        d = parseFloat(d.marginLeft),
        s.top -= i - a,
        s.bottom -= i - a,
        s.left -= e - d,
        s.right -= e - d,
        s.marginTop = a,
        s.marginLeft = d),
        (r && !n ? t.contains(l) : t === l && "BODY" !== l.nodeName) && (s = function(e, t, i) {
            var n = 2 < arguments.length && void 0 !== i && i
              , i = se(t, "top")
              , t = se(t, "left")
              , n = n ? -1 : 1;
    ...
    function ye(e, t, i, n, r) {
        ...
        "HTML" !== r.nodeName || function e(t) {
            ...
            if ("BODY" === i || "HTML" === i)
                return !1;
            if ("fixed" === Q(t, "position"))
                return !0;
            t = K(t);
            return !!t && e(t)
        }(o) ? s = l : (e = (o = de(e.ownerDocument)).height,
        o = o.width,
        ...
        return s.left += l ? i : i.left || 0,
        s.top += l ? i : i.top || 0,
        s.right -= l ? i : i.right || 0,
        s.bottom -= l ? i : i.bottom || 0,
        s
    }
    ...
    function Te(e, t, i) {
        ...
        var n = xe(e)
          ...
          , e = a ? "height" : "width"
          , a = a ? "width" : "height";
        return r[s] = t[s] + t[e] / 2 - n[e] / 2,
        r[o] = i === o ? t[o] - n[a] : t[Ce(o)],
        r
    }
    function Ee(e, t) {
    ...
    function Se(e, i, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, i) {
            ...
            e.enabled && U(t) && (i.offsets.popper = fe(i.offsets.popper),
            i.offsets.reference = fe(i.offsets.reference),
            i = t(i, e))
        }),
        i
    }
    ...
    function De(e, t, i, n) {
        i.updateBound = n,
        Me(e).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        e = J(e);
    ...
    function Le(i, n) {
        Object.keys(n).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && Oe(n[e]) && (t = "px"),
            i.style[e] = n[e] + t
        })
    }
    var Ae = Y && /Firefox/i.test(navigator.userAgent);
    function Pe(e, t, i) {
        var n, r = Ee(e, function(e) {
            return e.name === t
        ...
        return a || (n = "`" + t + "`",
        e = "`" + i + "`",
        console.warn(e + " modifier is required by " + n + " modifier in order to work, be sure to include it before " + n + "!")),
        a
    }
    ...
    function ze(e, t) {
        ...
        e = Ne.indexOf(e),
        e = Ne.slice(e + 1).concat(Ne.slice(0, e));
    ...
    var t = {
        ...
        modifiers: {
            shift: {
                ...
                enabled: !0,
                fn: function(e) {
                    var t, i, n = e.placement, r = n.split("-")[0], a = n.split("-")[1];
                    return a && (t = (i = e.offsets).reference,
                    n = i.popper,
                    r = (i = -1 !== ["bottom", "top"].indexOf(r)) ? "width" : "height",
                    r = {
                        start: he({}, i = i ? "left" : "top", t[i]),
                        end: he({}, i, t[i] + t[r] - n[r])
                    },
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var i = t.offset
                      ...
                      , a = n.split("-")[0]
                      , n = void 0
                      , n = Oe(+i) ? [+i, 0] : Re(i, r, t, a);
                    return "left" === a ? (r.top += n[0],
                    r.left -= n[1]) : "right" === a ? (r.top += n[0],
                    r.left += n[1]) : "top" === a ? (r.left += n[0],
                    r.top -= n[1]) : "bottom" === a && (r.left += n[0],
                    r.top += n[1]),
                    e.popper = r,
                    e
                },
                ...
                fn: function(e, n) {
                    ...
                    var o = n.priority
                      ...
                      , u = {
                        primary: function(e) {
                            var t = d[e];
                            return d[e] < l[e] && !n.escapeWithReference && (t = Math.max(d[e], l[e])),
                            he({}, e, t)
                        },
                        secondary: function(e) {
                            var t = "right" === e ? "left" : "top"
                              , i = d[t];
                            return d[e] > l[e] && !n.escapeWithReference && (i = Math.min(d[t], l[e] - ("right" === e ? d.width : d.height))),
                            he({}, t, i)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    var t = (a = e.offsets).popper
                      ...
                      , n = s ? "left" : "top"
                      , s = s ? "width" : "height";
                    return t[a] < r(i[n]) && (e.offsets.popper[n] = r(i[n]) - t[s]),
                    t[n] > r(i[a]) && (e.offsets.popper[n] = r(i[a])),
                    e
                }
            },
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var n = e.placement.split("-")[0]
                      ...
                      , u = s ? "bottom" : "right"
                      , n = xe(i)[o];
                    return a[u] - n < r[d] && (e.offsets.popper[d] -= r[d] - (a[u] - n)),
                    ...
                    e.arrowElement = i,
                    e.offsets.arrow = (he(i = {}, d, Math.round(l)),
                    he(i, t, ""),
                    i),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(d, u) {
                    if (_e(d.instance.modifiers, "inner"))
                        return d;
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return n[a ? "left" : "top"] = r[i] - (s ? n[a ? "width" : "height"] : 0),
                    e.placement = Ce(t),
                    e.offsets.popper = fe(n),
                    e
                }
            },
            hide: {
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    var i = t.x
                      , n = t.y
                      , r = e.offsets.popper;
                    void 0 !== (f = Ee(e.instance.modifiers, function(e) {
                    ...
                    var a, s, o, l, d = void 0 !== f ? f : t.gpuAcceleration, u = ne(e.instance.popper), c = me(u), h = {
                        position: r.position
                    }, p = (a = e,
                    ...
                    t = p ? o : t,
                    {
                        left: f(r % 2 == 1 && l % 2 == 1 && !a && p ? m.left - 1 : m.left),
                        top: t(m.top),
                        bottom: t(m.bottom),
                        right: f(m.right)
                    }), t = "bottom" === i ? "top" : "bottom", f = "right" === n ? "left" : "right", m = ke("transform"), i = void 0, n = void 0, n = "bottom" == t ? "HTML" === u.nodeName ? -u.clientHeight + p.bottom : -c.height + p.bottom : p.top, i = "right" == f ? "HTML" === u.nodeName ? -u.clientWidth + p.right : -c.width + p.right : p.left;
                    return d && m ? (h[m] = "translate3d(" + i + "px, " + n + "px, 0)",
                    h[t] = 0,
                    h[f] = 0,
                    h.willChange = "transform") : (d = "bottom" == t ? -1 : 1,
                    m = "right" == f ? -1 : 1,
                    h[t] = n * d,
                    h[f] = i * m,
                    h.willChange = t + ", " + f),
            ...
            applyStyle: {
                ...
                fn: function(e) {
                    var t, i;
                    return Le(e.instance.popper, e.styles),
                    t = e.instance.popper,
                    i = e.attributes,
                ...
                onLoad: function(e, t, i, n, r) {
                    return r = we(r, t, e, i.positionFixed),
      ...
      , $e = (h(qe, [{
        ...
        value: function() {
            return function() {
                ...
                this.state.isDestroyed || ((e = {
                    ...
                    flipped: !1,
                    offsets: {}
                }).offsets.reference = we(this.state, this.popper, this.reference, this.options.positionFixed),
        ...
        value: function() {
            return function() {
                ...
                _e(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
    ...
    var We = "dropdown"
      ...
      , nt = function() {
        ...
        return e.toggle = function() {
            var e;
            this._element.disabled || u.default(this._element).hasClass(Qe) || (e = u.default(this._menu).hasClass(Ke),
            d._clearMenus(),
            e || this.show(!0))
        }
        ,
        e.show = function(e) {
            if (void 0 === e && (e = !1),
            !(this._element.disabled || u.default(this._element).hasClass(Qe) || u.default(this._menu).hasClass(Ke))) {
                var t = {
                    relatedTarget: this._element
                }
                  , i = u.default.Event("show.bs.dropdown", t)
                  , n = d._getParentFromElement(this._element);
                if (u.default(n).trigger(i),
                !i.isDefaultPrevented()) {
                    if (!this._inNavbar && e) {
                        if (void 0 === $e)
                            throw new TypeError("Bootstrap's dropdowns require Popper.js (https://popper.js.org/)");
                        e = this._element;
                        "parent" === this._config.reference ? e = n : c.isElement(this._config.reference) && (e = this._config.reference,
        ...
        e.hide = function() {
            var e, t, i;
            this._element.disabled || u.default(this._element).hasClass(Qe) || !u.default(this._menu).hasClass(Ke) || (e = {
                relatedTarget: this._element
            },
            t = u.default.Event(Ge, e),
            i = d._getParentFromElement(this._element),
            u.default(i).trigger(t),
            t.isDefaultPrevented() || (this._popper && this._popper.destroy(),
            u.default(this._menu).toggleClass(Ke),
            u.default(i).toggleClass(Ke).trigger(u.default.Event(Ue, e))))
        }
        ,
        e.dispose = function() {
            u.default.removeData(this._element, Fe),
            u.default(this._element).off(Ve),
            this._element = null,
        ...
        e._getMenuElement = function() {
            var e;
            return this._menu || (e = d._getParentFromElement(this._element)) && (this._menu = e.querySelector(et)),
            this._menu
        }
        ,
        e._getPlacement = function() {
            var e = u.default(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = u.default(this._menu).hasClass(Je) ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : u.default(this._menu).hasClass(Je) && (t = "bottom-end"),
            t
        }
        ,
        ...
        d._clearMenus = function(e) {
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                for (var t = [].slice.call(document.querySelectorAll(Ze)), i = 0, n = t.length; i < n; i++) {
                    var r, a, s = d._getParentFromElement(t[i]), o = u.default(t[i]).data(Fe), l = {
                        relatedTarget: t[i]
                    };
                    e && "click" === e.type && (l.clickEvent = e),
                    o && (r = o._menu,
                    u.default(s).hasClass(Ke) && (e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && u.default.contains(s, e.target) || (a = u.default.Event(Ge, l),
                    u.default(s).trigger(a),
                    a.isDefaultPrevented() || ("ontouchstart"in document.documentElement && u.default(document.body).children().off("mouseover", null, u.default.noop),
        ...
        d._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || u.default(e.target).closest(et).length)) : Xe.test(e.which)) && !this.disabled && !u.default(this).hasClass(Qe)) {
                ...
                if (i || 27 !== e.which) {
                    ...
                    !i || 27 === e.which || 32 === e.which)
                        return 27 === e.which && u.default(t.querySelector(Ze)).trigger("focus"),
                    ...
                    0 !== i.length && (t = i.indexOf(e.target),
                    38 === e.which && 0 < t && t--,
    ...
    u.default(document).on(t, Ze, nt._dataApiKeydownHandler).on(t, et, nt._dataApiKeydownHandler).on(v + " keyup.bs.dropdown.data-api", nt._clearMenus).on(v, Ze, function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        nt._jQueryInterface.call(u.default(this), "toggle")
    ...
    var rt = "modal"
      ...
      , Tt = function() {
        ...
        e.show = function(e) {
            var t, i = this;
            this._isShown || this._isTransitioning || (u.default(this._element).hasClass(yt) && (this._isTransitioning = !0),
            t = u.default.Event(ct, {
                relatedTarget: e
            }),
        ...
        e.hide = function(e) {
            ...
            e ? (e = c.getTransitionDurationFromElement(this._element),
            u.default(this._element).one(c.TRANSITION_END, function(e) {
        ...
        e._getConfig = function(e) {
            return e = o({}, lt, e),
            c.typeCheckConfig(rt, e, dt),
            e
        }
        ,
        e._triggerBackdropTransition = function() {
            var e, t, i, n = this;
            "static" === this._config.backdrop ? (e = u.default.Event("hidePrevented.bs.modal"),
            u.default(this._element).trigger(e),
            ...
            u.default(this._element).one(c.TRANSITION_END, function() {
                n._element.classList.remove(wt),
                t || u.default(n._element).one(c.TRANSITION_END, function() {
        ...
        e._showElement = function(e) {
            ...
            i ? (i = c.getTransitionDurationFromElement(this._dialog),
            u.default(this._dialog).one(c.TRANSITION_END, e).emulateTransitionEnd(i)) : e()
        }
        ,
        e._enforceFocus = function() {
            var t = this;
            u.default(document).off(ht).on(ht, function(e) {
        ...
        e._setEscapeEvent = function() {
            var t = this;
            this._isShown ? u.default(this._element).on(mt, function(e) {
        ...
        e._setResizeEvent = function() {
            var t = this;
            this._isShown ? u.default(window).on(pt, function(e) {
        ...
        e._hideModal = function() {
            ...
            this._isTransitioning = !1,
            this._showBackdrop(function() {
                u.default(document.body).removeClass(vt),
                e._resetAdjustments(),
                e._resetScrollbar(),
                u.default(e._element).trigger(ut)
            })
        }
        ,
        ...
        e._showBackdrop = function(e) {
            var t, i = this, n = u.default(this._element).hasClass(yt) ? yt : "";
            ...
            e && (n ? (t = c.getTransitionDurationFromElement(this._backdrop),
            u.default(this._backdrop).one(c.TRANSITION_END, e).emulateTransitionEnd(t)) : e())) : !this._isShown && this._backdrop ? (u.default(this._backdrop).removeClass(bt),
            n = function() {
                i._removeBackdrop(),
                e && e()
            }
            ,
            u.default(this._element).hasClass(yt) ? (t = c.getTransitionDurationFromElement(this._backdrop),
            u.default(this._backdrop).one(c.TRANSITION_END, n).emulateTransitionEnd(t)) : n()) : e && e()
        }
        ,
        ...
        e._setScrollbar = function() {
            var e, t, r = this;
            this._isBodyOverflowing && (e = [].slice.call(document.querySelectorAll(xt)),
            ...
            u.default(e).each(function(e, t) {
                ...
                u.default(t).data("padding-right", i).css("padding-right", parseFloat(n) + r._scrollbarWidth + "px")
            }),
            u.default(t).each(function(e, t) {
                var i = t.style.marginRight
                  , n = u.default(t).css("margin-right");
                u.default(t).data("margin-right", i).css("margin-right", parseFloat(n) - r._scrollbarWidth + "px")
            }),
    ...
    u.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(e) {
        ...
        var r = u.default(t).one(ct, function(e) {
            e.isDefaultPrevented() || r.one(ut, function() {
    ...
    function kt(e, a, t) {
        ...
        if (t && "function" == typeof t)
            return t(e);
        for (var e = (new window.DOMParser).parseFromString(e, "text/html"), s = Object.keys(a), o = [].slice.call(e.body.querySelectorAll("*")), i = function(e, t) {
            var i = o[e]
            ...
            e.forEach(function(e) {
                !function(e, t) {
                    ...
                    if (-1 !== t.indexOf(i))
                        return -1 === Et.indexOf(i) || Boolean(e.nodeValue.match(St) || e.nodeValue.match(_t));
    ...
    var Mt = "tooltip"
      ...
      , Ft = function() {
        ...
        e.toggle = function(e) {
            ...
            (i = u.default(e.currentTarget).data(t)) || (i = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            u.default(e.currentTarget).data(t, i)),
            i._activeTrigger.click = !i._activeTrigger.click,
            i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)) : u.default(this.getTipElement()).hasClass($t) ? this._leave(null, this) : this._enter(null, this))
        }
        ,
        e.dispose = function() {
        ...
        e.show = function() {
            ...
            ,
            u.default(this.tip).hasClass(Rt) ? (i = c.getTransitionDurationFromElement(this.tip),
            u.default(this.tip).one(c.TRANSITION_END, n).emulateTransitionEnd(i)) : n()))
        }
        ,
        e.hide = function(e) {
            function t() {
            ...
            r.isDefaultPrevented() || (u.default(n).removeClass($t),
            ...
            u.default(this.tip).hasClass(Rt) ? (r = c.getTransitionDurationFromElement(n),
            u.default(n).one(c.TRANSITION_END, t).emulateTransitionEnd(r)) : t(),
            this._hoverState = "")
        }
        ,
        e.update = function() {
        ...
        e.addAttachmentClass = function(e) {
            u.default(this.getTipElement()).addClass(Lt + "-" + e)
        }
        ,
        ...
        e.setContent = function() {
            ...
            u.default(e).removeClass(Rt + " " + $t)
        }
        ,
        e.setElementContent = function(e, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = kt(t, this.config.whiteList, this.config.sanitizeFn)),
            e.html(t)) : e.text(t) : this.config.html ? u.default(t).parent().is(e) || e.empty().append(t) : e.text(u.default(t).text())
        }
        ,
        e.getTitle = function() {
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                ...
                "click" === e ? u.default(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(e) {
                    return i.toggle(e)
                }) : "manual" !== e && (t = e === qt ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                e = e === qt ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT,
                u.default(i.element).on(t, i.config.selector, function(e) {
                    return i._enter(e)
        ...
        e._enter = function(e, t) {
            ...
            (t = t || u.default(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            u.default(e.currentTarget).data(i, t)),
            e && (t._activeTrigger["focusin" === e.type ? Wt : qt] = !0),
            u.default(t.getTipElement()).hasClass($t) || t._hoverState === jt ? t._hoverState = jt : (clearTimeout(t._timeout),
            t._hoverState = jt,
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (u.default(e).removeClass(Rt),
        ...
        r._jQueryInterface = function(n) {
            return this.each(function() {
                var e = u.default(this)
                  , t = e.data(Dt)
                  , i = "object" == typeof n && n;
                if ((t || !/dispose|hide/.test(n)) && (t || (t = new r(this,i),
                e.data(Dt, t)),
                "string" == typeof n)) {
                    if (void 0 === t[n])
                        throw new TypeError('No method named "' + n + '"');
    ...
    u.default.fn[Vt] = ei._jQueryInterface,
    u.default.fn[Vt].Constructor = ei,
    u.default.fn[Vt].noConflict = function() {
        return u.default.fn[Vt] = Gt,
        ei._jQueryInterface
    }
    ;
    var ti = "scrollspy"
      ...
      , hi = function() {
        ...
        e._getConfig = function(e) {
            var t;
            return "string" != typeof (e = o({}, ai, "object" == typeof e && e ? e : {})).target && c.isElement(e.target) && ((t = u.default(e.target).attr("id")) || (t = c.getUID(ti),
        ...
        e._activate = function(t) {
            ...
            e.hasClass("dropdown-item") ? (e.closest(".dropdown").find(".dropdown-toggle").addClass(oi),
            e.addClass(oi)) : (e.addClass(oi),
            e.parents(li).prev(di + ", " + ui).addClass(oi),
    ...
    var pi = "bs.tab"
      ...
      , yi = function() {
        ...
        return e.show = function() {
            ...
            this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && u.default(this._element).hasClass(mi) || u.default(this._element).hasClass("disabled") || (a = u.default(this._element).closest(".nav, .list-group")[0],
            t = c.getSelectorFromElement(this._element),
            a && (r = "UL" === a.nodeName || "OL" === a.nodeName ? vi : gi,
            i = (i = u.default.makeArray(u.default(a).find(r)))[i.length - 1]),
            ...
            u.default(this._element).trigger(r),
            r.isDefaultPrevented() || n.isDefaultPrevented() || (t && (e = document.querySelector(t)),
        ...
        ,
        e.dispose = function() {
            u.default.removeData(this._element, pi),
            this._element = null
        }
        ,
        e._activate = function(e, t, i) {
            ...
            r && a ? (a = c.getTransitionDurationFromElement(r),
            u.default(r).removeClass("show").one(c.TRANSITION_END, t).emulateTransitionEnd(a)) : t()
        }
        ,
        e._transitionComplete = function(e, t, i) {
            var n;
            t && (u.default(t).removeClass(mi),
            (n = u.default(t.parentNode).find("> .dropdown-menu .active")[0]) && u.default(n).removeClass(mi),
            "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)),
            u.default(e).addClass(mi),
            "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0),
            c.reflow(e),
            e.classList.contains("fade") && e.classList.add("show"),
            e.parentNode && u.default(e.parentNode).hasClass("dropdown-menu") && ((t = u.default(e).closest(".dropdown")[0]) && (t = [].slice.call(t.querySelectorAll(".dropdown-toggle")),
            u.default(t).addClass(mi)),
    ...
    var bi = "toast"
      ...
      , ki = function() {
        ...
        var e = n.prototype;
        return e.show = function() {
            var e, t = this, i = u.default.Event("show.bs.toast");
            ...
            this._config.animation ? (i = c.getTransitionDurationFromElement(this._element),
            u.default(this._element).one(c.TRANSITION_END, e).emulateTransitionEnd(i)) : e())
        }
        ,
        e.hide = function() {
            var e;
            this._element.classList.contains(Ti) && (e = u.default.Event("hide.bs.toast"),
            u.default(this._element).trigger(e),
        ...
        ,
        e._getConfig = function(e) {
            return e = o({}, _i, u.default(this._element).data(), "object" == typeof e && e ? e : {}),
            c.typeCheckConfig(bi, e, this.constructor.DefaultType),
            e
        }
        ,
        e._setListeners = function() {
        ...
        e._close = function() {
            ...
            this._config.animation ? (t = c.getTransitionDurationFromElement(this._element),
            u.default(this._element).one(c.TRANSITION_END, e).emulateTransitionEnd(t)) : e()
        }
        ,
        ...
        n._jQueryInterface = function(i) {
            return this.each(function() {
                var e = u.default(this)
                  , t = e.data(wi);
                if (t || (t = new n(this,"object" == typeof i && i),
                e.data(wi, t)),
                "string" == typeof i) {
                    if (void 0 === t[i])
                        throw new TypeError('No method named "' + i + '"');
...
function(e, t) {
    ...
    function h() {
        var e, t = this.parentNode.querySelector(c.CUSTOMFILELABEL);
        t && (e = i(t),
        (t = n(this)).length ? e.textContent = t : o(this))
    }
    function p() {
        for (var e = [].slice.call(this.querySelectorAll(c.INPUT)).filter(function(e) {
            return !!e.bsCustomFileInput
        }), t = 0, i = e.length; t < i; t++)
            o(e[t])
    }
    ...
    return {
            ...
            for (var i, n, r = [].slice.call(document.querySelectorAll(e)), a = [].slice.call(document.querySelectorAll(t)), s = 0, o = r.length; s < o; s++) {
                ...
                Object.defineProperty(l, f, {
                    value: {
                        ...
                        n = "",
                        (i = (i = l).parentNode.querySelector(c.CUSTOMFILELABEL)) && (n = i.textContent),
                        n)
                    },
                    writable: !0
                }),
        ...
        destroy: function() {
            for (var e = [].slice.call(document.querySelectorAll(c.FORM)).filter(function(e) {
                return !!e.bsCustomFileInput
                ...
                o(r),
                r[f] = void 0,
                r.removeEventListener(g, h)
            }
            for (var a = 0, s = e.length; a < s; a++)
                e[a].removeEventListener(m, p),
                e[a][f] = void 0
        }
    }
}),
    ...
    function r(l, d, u) {
        ...
        u.fn[l] = function(e) {
            if ("string" != typeof e)
                ...
                this;
            var n, r, a, s, o, t = i.call(arguments, 1);
            return r = t,
            s = "$()." + l + '("' + (n = e) + '")',
            (e = this).each(function(e, t) {
                var i = u.data(t, l);
                i ? (t = i[n]) && "_" != n.charAt(0) ? (i = t.apply(i, r),
                a = void 0 === a ? i : a) : c(s + " is not a valid method") : c(l + " not initialized. Cannot call methods, i.e. " + s)
            }),
            void 0 !== a ? a : e
        }
        ,
...
function(e, t) {
    ...
    function b(e) {
        ...
        e && "object" == typeof e && e.nodeType) {
            ...
            n = p(t.height);
            return !1 !== n && (i.height = n + (e ? 0 : l + h)),
            i.innerWidth = i.width - (o + c),
...
function(t, i) {
    ...
    ;
    var u = i.console;
    return d.htmlInit = function(o, l) {
        d.docReady(function() {
            var e = d.toDashed(l)
              , r = "data-" + e
...
function(e, t) {
    ...
    e.layoutPosition = function() {
        ...
        t[a] = this.getXValue(r),
        t[i] = "";
        r = n ? "paddingTop" : "paddingBottom",
        i = n ? "top" : "bottom",
        n = n ? "bottom" : "top",
        r = this.position.y + e[r];
        t[i] = this.getYValue(r),
        t[n] = "",
        this.css(t),
    ...
    e._transitionTo = function(e, t) {
        ...
        !r || this.isTransitioning ? (i = e - i,
        t -= n,
        (n = {}).transform = this.getTranslate(i, t),
        this.transition({
            to: n,
            onTransitionEnd: {
...
function(r, a) {
    ...
    function u(e, t) {
        ...
        (d[t] = this)._create(),
        this._getOption("initLayout") && this.layout()) : s && s.error("Bad element for " + this.constructor.namespace + ": " + (i || e))
    }
    ...
    c.dispatchEvent = function(e, t, i) {
        ...
        t ? ((t = o.Event(t)).type = e,
        this.$element.trigger(t, i)) : this.$element.trigger(e, i))
    }
    ,
    c.ignore = function(e) {
        e = this.getItem(e);
...
function(e, t) {
    ...
    e.measureColumns = function() {
        ...
        this.columnWidth || (i = (t = this.items[0]) && t.element,
    ...
    e._getItemLayoutPosition = function(e) {
        ...
        for (var t = e.size.outerWidth % this.columnWidth, i = Math[t && t < 1 ? "round" : "ceil"](e.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), t = {
            ...
            y: n.y
        }, r = n.y + e.size.outerHeight, a = i + n.col, s = n.col; s < a; s++)
            this.colYs[s] = r;
        return t
    }
    ,
    ...
    e._manageStamp = function(e) {
        ...
        for (var a = (this._getOption("originTop") ? i.top : i.bottom) + t.outerHeight, s = n; s <= r; s++)
            this.colYs[s] = Math.max(a, this.colYs[s])
    }
    ,
...
function(e, t) {
    ...
    var t = {
            ...
            function r(e) {
                ...
                if (t) {
                    ...
                    T(t).is(a))
                        ...
                        for (var n = T(t).parents(), r = 0; r < n.length; r += 1)
                            T(n[r]).is(a) && s.apply(n[r], i)
                }
            }
            function o(e) {
                ...
                for (var l = s[o], d = 0; d < this.length; d += 1) {
                    ...
                    c && c.length)
                        for (var h = c.length - 1; 0 <= h; --h) {
                            var p = c[h];
                            (!r || p.listener !== r) && !(r && p.listener && p.listener.dom7proxy && p.listener.dom7proxy === r) && r || (u.removeEventListener(l, p.proxyListener, a),
                            c.splice(h, 1))
                        }
                }
            return this
            ...
            for (var i = e[0].split(" "), n = e[1], r = 0; r < i.length; r += 1)
                for (var a = i[r], s = 0; s < this.length; s += 1) {
                    ...
                    try {
                        ...
                        (l = v.createEvent("Event")).initEvent(a, !0, !0),
                        l.detail = n
                    }
        ...
        offset: function() {
            if (0 < this.length) {
                var e = this[0]
                  ...
                  , i = e === G ? G.scrollY : e.scrollTop
                  , e = e === G ? G.scrollX : e.scrollLeft;
                return {
                    top: t.top + i - n,
                    left: t.left + e - r
                }
        ...
        css: function(e, t) {
            ...
            if (1 === arguments.length) {
                ...
                if (this[0])
                    return G.getComputedStyle(this[0], null).getPropertyValue(e)
            }
        ...
        children: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
                for (var n = this[i].childNodes, r = 0; r < n.length; r += 1)
                    e ? 1 === n[r].nodeType && T(n[r]).is(e) && t.push(n[r]) : 1 === n[r].nodeType && t.push(n[r]);
            return new l(a(t))
        },
        filter: function(e) {
            for (var t = [], i = 0; i < this.length; i += 1)
        ...
        add: function() {
            ...
            for (var i = 0; i < e.length; i += 1)
                for (var n = T(e[i]), r = 0; r < n.length; r += 1)
    ...
    var U = {
        ...
        getTranslate: function(e, t) {
            var i, n, r;
            void 0 === t && (t = "x");
            e = G.getComputedStyle(e, null);
            return G.WebKitCSSMatrix ? (6 < (n = e.transform || e.webkitTransform).split(",").length && (n = n.split(", ").map(function(e) {
                return e.replace(",", ".")
            }).join(", ")),
            r = new G.WebKitCSSMatrix("none" === n ? "" : n)) : i = (r = e.MozTransform || e.OTransform || e.MsTransform || e.msTransform || e.transform || e.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
            "x" === t && (n = G.WebKitCSSMatrix ? r.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
            "y" === t && (n = G.WebKitCSSMatrix ? r.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
            n || 0
        },
        parseUrlQuery: function(e) {
            var t, i, n, r, a = {}, e = e || G.location.href;
            if ("string" == typeof e && e.length)
                for (r = (i = (e = -1 < e.indexOf("?") ? e.replace(/\S*\?/, "") : "").split("&").filter(function(e) {
                    return "" !== e
                })).length,
                t = 0; t < r; t += 1)
            ...
            for (var i = Object(e[0]), n = 1; n < e.length; n += 1) {
                ...
                if (null != r)
                    for (var a = Object.keys(Object(r)), s = 0, o = a.length; s < o; s += 1) {
                        ...
                        void 0 !== d && d.enumerable && (U.isObject(i[l]) && U.isObject(r[l]) ? U.extend(i[l], r[l]) : !U.isObject(i[l]) && U.isObject(r[l]) ? (i[l] = {},
                        U.extend(i[l], r[l])) : i[l] = r[l])
                    }
            }
            return i
        }
      ...
      , x = {
        touch: !!("ontouchstart"in G || G.DocumentTouch && v instanceof G.DocumentTouch),
    ...
    i.prototype.once = function(i, n, e) {
        var r = this;
        return "function" != typeof n ? r : (a.f7proxy = n,
        r.on(i, a, e));
        function a() {
            for (var e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
    ...
    var o = {
        ...
        updateSlides: function() {
            ...
            var m, g = e.snapGrid.length, v = e.snapGrid.length, y = t.spaceBetween, b = -p, w = 0, x = 0;
            if (void 0 !== n) {
                ...
                1 < t.slidesPerColumn && (m = Math.floor(l / t.slidesPerColumn) === l / e.params.slidesPerColumn ? l : Math.ceil(l / t.slidesPerColumn) * t.slidesPerColumn,
                "auto" !== t.slidesPerView && "row" === t.slidesPerColumnFill && (m = Math.max(m, t.slidesPerView * t.slidesPerColumn)));
                for (var C, T, E, S, _, k = t.slidesPerColumn, M = m / k, D = Math.floor(l / t.slidesPerColumn), I = 0; I < l; I += 1) {
                    z = 0;
                    var O, L, A, P, N, z, B, j, H, R, $, q, W = o.eq(I);
                    1 < t.slidesPerColumn && (N = P = A = void 0,
                    "row" === t.slidesPerColumnFill && 1 < t.slidesPerGroup ? (q = Math.floor(I / (t.slidesPerGroup * t.slidesPerColumn)),
                    O = I - t.slidesPerColumn * t.slidesPerGroup * q,
                    L = 0 === q ? t.slidesPerGroup : Math.min(Math.ceil((l - q * k * t.slidesPerGroup) / k), t.slidesPerGroup),
                    A = (P = O - (N = Math.floor(O / L)) * L + q * t.slidesPerGroup) + N * m / k,
                    W.css({
                        ...
                        "-webkit-order": A,
                        order: A
                    })) : "column" === t.slidesPerColumnFill ? (N = I - (P = Math.floor(I / k)) * k,
                    (D < P || P === D && N === k - 1) && k <= (N += 1) && (N = 0,
                    P += 1)) : P = I - (N = Math.floor(I / M)) * M,
                    W.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== N && t.spaceBetween && t.spaceBetween + "px")),
                    "none" !== W.css("display") && ("auto" === t.slidesPerView ? (q = G.getComputedStyle(W[0], null),
                    A = W[0].style.transform,
                    P = W[0].style.webkitTransform,
                    A && (W[0].style.transform = "none"),
                    P && (W[0].style.webkitTransform = "none"),
                    z = t.roundLengths ? e.isHorizontal() ? W.outerWidth(!0) : W.outerHeight(!0) : e.isHorizontal() ? (B = parseFloat(q.getPropertyValue("width")),
                    j = parseFloat(q.getPropertyValue("padding-left")),
                    H = parseFloat(q.getPropertyValue("padding-right")),
                    R = parseFloat(q.getPropertyValue("margin-left")),
                    $ = parseFloat(q.getPropertyValue("margin-right")),
                    (N = q.getPropertyValue("box-sizing")) && "border-box" === N ? B + R + $ : B + j + H + R + $) : (B = parseFloat(q.getPropertyValue("height")),
                    j = parseFloat(q.getPropertyValue("padding-top")),
                    H = parseFloat(q.getPropertyValue("padding-bottom")),
                    R = parseFloat(q.getPropertyValue("margin-top")),
                    $ = parseFloat(q.getPropertyValue("margin-bottom")),
                    (q = q.getPropertyValue("box-sizing")) && "border-box" === q ? B + R + $ : B + j + H + R + $),
                    A && (W[0].style.transform = A),
                    P && (W[0].style.webkitTransform = P),
                    t.roundLengths && (z = Math.floor(z))) : (z = (n - (t.slidesPerView - 1) * y) / t.slidesPerView,
                    t.roundLengths && (z = Math.floor(z)),
                    o[I] && (e.isHorizontal() ? o[I].style.width = z + "px" : o[I].style.height = z + "px")),
                    o[I] && (o[I].swiperSlideSize = z),
                    c.push(z),
                    t.centeredSlides ? (b = b + z / 2 + w / 2 + y,
                    0 === w && 0 !== I && (b = b - n / 2 - y),
                    0 === I && (b = b - n / 2 - y),
                    Math.abs(b) < .001 && (b = 0),
                    ...
                    (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && d.push(b),
                    u.push(b),
                    b = b + z + y),
                    e.virtualSize += z + y,
                    w = z,
                ...
                1 < t.slidesPerColumn && (e.virtualSize = (z + t.spaceBetween) * m,
                ...
                t.centeredSlides)) {
                    ...
                    for (var F = 0; F < d.length; F += 1) {
                        ...
                        d[F] < e.virtualSize + d[0] && C.push(V)
                    }
                    d = C
                }
                if (!t.centeredSlides) {
                    ...
                    for (var Y = 0; Y < d.length; Y += 1) {
                        ...
                        d[Y] <= e.virtualSize - n && C.push(X)
                    }
                    d = C,
                    1 < Math.floor(e.virtualSize - n) - Math.floor(d[d.length - 1]) && d.push(e.virtualSize - n)
                }
                0 === d.length && (d = [0]),
                0 !== t.spaceBetween && (e.isHorizontal() ? r ? o.filter(h).css({
                    marginLeft: y + "px"
                }) : o.filter(h).css({
                    marginRight: y + "px"
                }) : o.filter(h).css({
                ...
                t.centeredSlides && t.centeredSlidesBounds && (T = 0,
                c.forEach(function(e) {
                    T += e + (t.spaceBetween || 0)
                }),
                E = (T -= t.spaceBetween) - n,
                d = d.map(function(e) {
                    return e < 0 ? -p : E < e ? E + f : e
                })),
                t.centerInsufficientSlides && (S = 0,
                c.forEach(function(e) {
                    S += e + (t.spaceBetween || 0)
                }),
                (S -= t.spaceBetween) < n && (_ = (n - S) / 2,
        ...
        updateSlidesProgress: function(e) {
            ...
            if (0 !== n.length) {
                ...
                for (var s = 0; s < n.length; s += 1) {
                    var o, l, d = n[s], u = (a + (i.centeredSlides ? t.minTranslate() : 0) - d.swiperSlideOffset) / (d.swiperSlideSize + i.spaceBetween);
                    (i.watchSlidesVisibility || i.centeredSlides && i.autoHeight) && (l = (o = -(a - d.swiperSlideOffset)) + t.slidesSizesGrid[s],
        ...
        updateProgress: function(e) {
            ...
            var i = t.params
              ...
              , s = a
              , o = l = t.isEnd
              , l = 0 == n ? a = !(r = 0) : (a = (r = (e - t.minTranslate()) / n) <= 0,
            1 <= r);
            U.extend(t, {
                progress: r,
                isBeginning: a,
        ...
        updateActiveIndex: function(e) {
            ...
            if (void 0 === d) {
                for (var u = 0; u < n.length; u += 1)
                    void 0 !== n[u + 1] ? i >= n[u] && i < n[u + 1] - (n[u + 1] - n[u]) / 2 ? d = u : i >= n[u] && i < n[u + 1] && (d = u + 1) : i >= n[u] && (d = u);
            ...
            d !== s ? (r = parseInt(t.slides.eq(d).attr("data-swiper-slide-index") || d, 10),
            U.extend(t, {
                snapIndex: a,
                realIndex: r,
                previousIndex: s,
            ...
            (t.initialized || t.params.runCallbacksOnInit) && t.emit("slideChange")) : a !== l && (t.snapIndex = a,
            t.emit("snapIndexChange"))
        },
    ...
    var d = {
        getTranslate: function(e) {
            ...
            var t = this.params
              ...
              , n = this.translate
              , r = this.$wrapperEl;
            return t.virtualTranslate ? i ? -n : n : t.cssMode ? n : (e = U.getTranslate(r[0], e),
            i && (e = -e),
            e || 0)
        },
        ...
        translateTo: function(e, t, i, n, r) {
            ...
            var l = a.minTranslate()
              , d = a.maxTranslate()
              , d = n && l < e ? l : n && e < d ? d : e;
            if (a.updateProgress(d),
            s.cssMode) {
                e = a.isHorizontal();
                return 0 !== t && o.scrollTo ? o.scrollTo(((s = {})[e ? "left" : "top"] = -d,
                s.behavior = "smooth",
                s)) : o[e ? "scrollLeft" : "scrollTop"] = -d,
                !0
            }
    ...
    var u = {
        ...
        transitionStart: function(e, t) {
            ...
            e && i !== r && ("reset" !== t ? (this.emit("slideChangeTransitionStart"),
        ...
        transitionEnd: function(e, t) {
            ...
            e && n !== r && ("reset" !== t ? (i.emit("slideChangeTransitionEnd"),
            "next" === t ? i.emit("slideNextTransitionEnd") : i.emit("slidePrevTransitionEnd")) : i.emit("slideResetTransitionEnd")))
        }
    };
    var c = {
        slideTo: function(e, t, i, n) {
            ...
            (e += Math.floor((a - e) / r.params.slidesPerGroup)) >= o.length && (e = o.length - 1),
            ...
            if (s.cssMode) {
                u = r.isHorizontal(),
                s = -f;
                return c && (s = h.scrollWidth - h.offsetWidth - s),
                0 !== t && h.scrollTo ? h.scrollTo(((c = {})[u ? "left" : "top"] = s,
                c.behavior = "smooth",
                c)) : h[u ? "scrollLeft" : "scrollTop"] = s,
                !0
            }
            ...
            r.transitionEnd(i, p)) : (r.setTransition(t),
            r.setTranslate(f),
            r.updateActiveIndex(a),
            r.updateSlidesClasses(),
            r.emit("beforeTransitionStart", t, n),
        ...
        slidePrev: function(e, t, i) {
            ...
            var u, c = d(l ? n.translate : -n.translate), l = s.map(d), h = (o.map(d),
            s[l.indexOf(c)],
            s[l.indexOf(c) - 1]);
        ...
        slideToClosest: function(e, t, i, n) {
            ...
            return l >= r.snapGrid[o] ? (s = r.snapGrid[o],
            (r.snapGrid[o + 1] - s) * n < l - s && (a += r.params.slidesPerGroup)) : l - (l = r.snapGrid[o - 1]) <= (r.snapGrid[o] - l) * n && (a -= r.params.slidesPerGroup),
            a = Math.max(a, 0),
    ...
    var h = {
        ...
        loopFix: function() {
            ...
            l += n,
            e.slideTo(l, 0, !1, !0) && 0 != s && e.setTranslate((o ? -e.translate : e.translate) - s)) : t >= i.length - n && (l = -i.length + t + n,
            l += n,
    ...
    var p = {
        setGrabCursor: function(e) {
            var t;
            x.touch || !this.params.simulateTouch || this.params.watchOverflow && this.isLocked || this.params.cssMode || ((t = this.el).style.cursor = "move",
        ...
        addSlide: function(e, t) {
            ...
            if (e <= 0)
                ...
                for (var h = 0; h < l.length; h += 1)
                    n.append(l[h]);
                r.loop && i.loopCreate(),
                r.observer && x.observer || i.update(),
    ...
    }, I = (f = G.navigator.platform,
    m = G.navigator.userAgent,
    g = {
        ios: !1,
        android: !1,
        androidChrome: !1,
    ...
    f = "MacIntel" === f,
    !C && f && x.touch && (1024 === y && 1366 === b || 834 === y && 1194 === b || 834 === y && 1112 === b || 768 === y && 1024 === b) && (C = m.match(/(Version)\/([\d.]+)/),
    f = !1),
    g.ie = _,
    g.edge = k,
    g.firefox = M,
    ...
    g.osVersion = w[2],
    g.android = !0,
    g.androidChrome = 0 <= m.toLowerCase().indexOf("chrome")),
    (C || S || E) && (g.os = "ios",
    g.ios = !0),
    S && !E && (g.osVersion = S[2].replace(/_/g, "."),
    g.iphone = !0),
    C && (g.osVersion = C[2].replace(/_/g, "."),
    g.ipad = !0),
    E && (g.osVersion = E[3] ? E[3].replace(/_/g, ".") : null,
    g.ipod = !0),
    g.ios && g.osVersion && 0 <= m.indexOf("Version/") && "10" === g.osVersion.split(".")[0] && (g.osVersion = m.toLowerCase().split("version/")[1].split(" ")[0]),
    g.webView = !(!(S || C || E) || !m.match(/.*AppleWebKit(?!.*Safari)/i) && !G.navigator.standalone) || G.matchMedia && G.matchMedia("(display-mode: standalone)").matches,
    g.webview = g.webView,
    g.standalone = g.webView,
    g.desktop = !(g.ios || g.android) || s,
    g.desktop && (g.electron = s,
    g.macos = f,
    g.windows = e,
    g.macos && (g.os = "macos"),
    g.windows && (g.os = "windows")),
    g.pixelRatio = G.devicePixelRatio || 1,
    g);
    function O() {
        var e, t, i = this, n = i.params, r = i.el;
        r && 0 === r.offsetWidth || (n.breakpoints && i.setBreakpoint(),
        e = i.allowSlideNext,
        t = i.allowSlidePrev,
        r = i.snapGrid,
        i.allowSlideNext = !0,
    ...
    var P = {
      ...
      , N = {
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = function(e) {
                    var t, i, n, r, a, s = this, o = s.touchEventsData, l = s.params, d = s.touches;
                    s.animating && l.preventInteractionOnTransition || ((t = e).originalEvent && (t = t.originalEvent),
                    i = T(t.target),
                    "wrapper" === l.touchEventsTarget && !i.closest(s.wrapperEl).length || (o.isTouchEvent = "touchstart" === t.type,
                    !o.isTouchEvent && "which"in t && 3 === t.which || !o.isTouchEvent && "button"in t && 0 < t.button || o.isTouched && o.isMoved || (l.noSwiping && i.closest(l.noSwipingSelector || "." + l.noSwipingClass)[0] ? s.allowClick = !0 : l.swipeHandler && !i.closest(l.swipeHandler)[0] || (d.currentX = ("touchstart" === t.type ? t.targetTouches[0] : t).pageX,
                    ...
                    r && (n <= e || n >= G.screen.width - e) || (U.extend(o, {
                        isTouched: !0,
                        isMoved: !1,
                    ...
                    i.isTouched) {
                        if (!i.isTouchEvent || "touchmove" === s.type) {
                            ...
                            if (i.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
                                if (t.isVertical()) {
                                    if (e < r.startY && t.translate <= t.maxTranslate() || e > r.startY && t.translate >= t.minTranslate())
                                        return i.isTouched = !1,
                                        void (i.isMoved = !1)
                                } else if (l < r.startX && t.translate <= t.maxTranslate() || l > r.startX && t.translate >= t.minTranslate())
                                    return;
                            if (i.isTouchEvent && v.activeElement && s.target === v.activeElement && T(s.target).is(i.formElements))
                                return i.isMoved = !0,
                                void (t.allowClick = !1);
                            ...
                            !(s.targetTouches && 1 < s.targetTouches.length)) {
                                r.currentX = l,
                                r.currentY = e;
                                o = r.currentX - r.startX,
                                l = r.currentY - r.startY;
                                if (!(t.params.threshold && Math.sqrt(Math.pow(o, 2) + Math.pow(l, 2)) < t.params.threshold))
                                    if (void 0 === i.isScrolling && (t.isHorizontal() && r.currentY === r.startY || t.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : 25 <= o * o + l * l && (e = 180 * Math.atan2(Math.abs(l), Math.abs(o)) / Math.PI,
                                    i.isScrolling = t.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)),
                                    ...
                                    i.isScrolling)
                                        ...
                                        o *= n.touchRatio,
                                        a && (o = -o),
                                        t.swipeDirection = 0 < o ? "prev" : "next",
                                        i.currentTranslate = o + i.startTranslate;
                                        l = !0,
                                        a = n.resistanceRatio;
                                        if (n.touchReleaseOnEdges && (a = 0),
                                        0 < o && i.currentTranslate > t.minTranslate() ? (l = !1,
                                        n.resistance && (i.currentTranslate = t.minTranslate() - 1 + Math.pow(-t.minTranslate() + i.startTranslate + o, a))) : o < 0 && i.currentTranslate < t.maxTranslate() && (l = !1,
                                        n.resistance && (i.currentTranslate = t.maxTranslate() + 1 - Math.pow(t.maxTranslate() - i.startTranslate - o, a))),
                                        ...
                                        0 < n.threshold) {
                                            if (!(Math.abs(o) > n.threshold || i.allowThresholdMove))
                ...
                e.onTouchEnd = function(e) {
                    ...
                    var u, c = U.now(), e = c - i.touchStartTime;
                        ...
                        if (n.freeMode)
                            if (u < -t.minTranslate())
                                ...
                                if (n.freeModeMomentum) {
                                    1 < i.velocities.length ? (v = i.velocities.pop(),
                                    p = i.velocities.pop(),
                                    ...
                                    (150 < p || 300 < U.now() - v.time) && (t.velocity = 0)) : t.velocity = 0,
                                    ...
                                    var h = 1e3 * n.freeModeMomentumRatio
                                      ...
                                      , f = t.translate + p;
                                    a && (f = -f);
                                    var m, g, v = !1, p = 20 * Math.abs(t.velocity) * n.freeModeMomentumBounceRatio;
                                    if (f < t.maxTranslate())
                                        n.freeModeMomentumBounce ? (f + t.maxTranslate() < -p && (f = t.maxTranslate() - p),
                                        m = t.maxTranslate(),
                                        v = !0,
                                        i.allowMomentumBounce = !0) : f = t.maxTranslate(),
                                        n.loop && n.centeredSlides && (g = !0);
                                    else if (f > t.minTranslate())
                                        n.freeModeMomentumBounce ? (f - t.minTranslate() > p && (f = t.minTranslate() + p),
                                        m = t.minTranslate(),
                                        v = !0,
                                        i.allowMomentumBounce = !0) : f = t.minTranslate(),
                                        n.loop && n.centeredSlides && (g = !0);
                                    ...
                                    n.freeModeMomentumBounce && v ? (t.updateProgress(m),
                                    t.setTransition(h),
                                    t.setTranslate(f),
                            ...
                            for (var w = 0, x = t.slidesSizesGrid[0], C = 0; C < o.length; C += C < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
                                ...
                                void 0 !== o[C + T] ? u >= o[C] && u < o[C + T] && (x = o[(w = C) + T] - o[C]) : u >= o[C] && (w = C,
                                x = o[o.length - 1] - o[o.length - 2])
                            }
                            v = (u - o[w]) / x,
                            h = w < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
                            e > n.longSwipesMs ? n.longSwipes ? ("next" === t.swipeDirection && (v >= n.longSwipesRatio ? t.slideTo(w + h) : t.slideTo(w)),
                            "prev" === t.swipeDirection && (v > 1 - n.longSwipesRatio ? t.slideTo(w + h) : t.slideTo(w))) : t.slideTo(t.activeIndex) : n.shortSwipes ? t.navigation && (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl) ? d.target === t.navigation.nextEl ? t.slideTo(w + h) : t.slideTo(w) : ("next" === t.swipeDirection && t.slideTo(w + h),
                ...
                .bind(e);
                var a, s = !!t.nested;
                !x.touch && x.pointerEvents ? (n.addEventListener(i.start, e.onTouchStart, !1),
                v.addEventListener(i.move, e.onTouchMove, s),
                v.addEventListener(i.end, e.onTouchEnd, !1)) : (x.touch && (a = !("touchstart" !== i.start || !x.passiveListener || !t.passiveListeners) && {
                    passive: !0,
                    capture: !1
                },
                n.addEventListener(i.start, e.onTouchStart, a),
                n.addEventListener(i.move, e.onTouchMove, x.passiveListener ? {
                    passive: !1,
                    capture: s
                } : s),
                n.addEventListener(i.end, e.onTouchEnd, a),
                i.cancel && n.addEventListener(i.cancel, e.onTouchEnd, a),
                L || (v.addEventListener("touchstart", A),
                L = !0)),
                (t.simulateTouch && !I.ios && !I.android || t.simulateTouch && !x.touch && I.ios) && (n.addEventListener("mousedown", e.onTouchStart, !1),
                v.addEventListener("mousemove", e.onTouchMove, s),
                ...
                t.updateOnWindowResize ? e.on(I.ios || I.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O, !0) : e.on("observerUpdate", O, !0)
            },
            detachEvents: function() {
                var e, t = this, i = t.params, n = t.touchEvents, r = t.el, a = t.wrapperEl, s = !!i.nested;
                !x.touch && x.pointerEvents ? (r.removeEventListener(n.start, t.onTouchStart, !1),
                v.removeEventListener(n.move, t.onTouchMove, s),
                v.removeEventListener(n.end, t.onTouchEnd, !1)) : (x.touch && (e = !("onTouchStart" !== n.start || !x.passiveListener || !i.passiveListeners) && {
                    passive: !0,
                    capture: !1
                },
                ...
                (i.simulateTouch && !I.ios && !I.android || i.simulateTouch && !x.touch && I.ios) && (r.removeEventListener("mousedown", t.onTouchStart, !1),
                v.removeEventListener("mousemove", t.onTouchMove, s),
                ...
                t.off(I.ios || I.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", O)
            }
        },
        breakpoints: {
            setBreakpoint: function() {
                var e = this
                  ...
                  , n = e.loopedSlides;
                void 0 === n && (n = 0);
                var r, a, s, o, l = e.params, d = e.$el, u = l.breakpoints;
                !u || u && 0 === Object.keys(u).length || (r = e.getBreakpoint(u)) && e.currentBreakpoint !== r && ((a = r in u ? u[r] : void 0) && ["slidesPerView", "spaceBetween", "slidesPerGroup", "slidesPerGroupSkip", "slidesPerColumn"].forEach(function(e) {
                    var t = a[e];
                ...
                o && !u ? d.removeClass(l.containerModifierClass + "multirow " + l.containerModifierClass + "multirow-column") : !o && u && (d.addClass(l.containerModifierClass + "multirow"),
                "column" === s.slidesPerColumnFill && d.addClass(l.containerModifierClass + "multirow-column")),
        ...
        images: {
            loadImage: function(e, t, i, n, r, a) {
                ...
                !(T(e).parent("picture")[0] || e.complete && r) && t ? ((r = new G.Image).onload = s,
                r.onerror = s,
                n && (r.sizes = n),
                i && (r.srcset = i),
                t && (r.src = t)) : s()
      ...
      , B = function(d) {
        function u() {
            for (var i, e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
            i = (i = 1 === e.length && e[0].constructor && e[0].constructor === Object ? e[0] : (a = e[0],
            e[1])) || {},
            i = U.extend({}, i),
            a && !i.el && (i.el = a),
            d.call(this, i),
            ...
            n.params = U.extend({}, r, z, i),
            n.originalParams = U.extend({}, n.params),
            n.passedParams = U.extend({}, i);
            var a, s, o = (n.$ = T)(n.params.el);
            if (a = o[0]) {
                if (1 < o.length) {
                    var l = [];
                ...
                return a.swiper = n,
                o.data("swiper", n),
                a && a.shadowRoot && a.shadowRoot.querySelector ? (s = T(a.shadowRoot.querySelector("." + n.params.wrapperClass))).children = function(e) {
                    return o.children(e)
                }
                ...
                U.extend(n, {
                    ...
                    touchEvents: (a = ["touchstart", "touchmove", "touchend", "touchcancel"],
        ...
        d && (u.__proto__ = d),
        u.prototype = Object.create(d && d.prototype);
        var e = {
            extendedDefaults: {
                configurable: !0
            },
      ...
      , p = {
        ...
        on: {
            init: function() {
                ...
                G.addEventListener("orientationchange", this.resize.orientationChangeHandler)
            },
            destroy: function() {
                G.removeEventListener("resize", this.resize.resizeHandler),
                G.removeEventListener("orientationchange", this.resize.orientationChangeHandler)
            }
        }
    }
      , H = {
        ...
        attach: function(e, t) {
            ...
            var i = this
              , n = new H.func(function(e) {
                ...
                ,
                G.requestAnimationFrame ? G.requestAnimationFrame(t) : G.setTimeout(t, 0)) : i.emit("observerUpdate", e[0])
            }
            );
            n.observe(e, {
      ...
      , R = {
        update: function(e) {
            ...
            u === m && c === g && !e)
                return t.slidesGrid !== p && v !== i && t.slides.css(d, v + "px"),
            ...
            for (var C = 0; C < h.length; C += 1)
                m <= C && C <= g && (void 0 === c || e ? w.push(C) : (c < C && w.push(C),
                C < u && b.push(C)));
        ...
        prependSlide: function(e) {
            var n, r, t = this.activeIndex, i = t + 1, a = 1;
            if (Array.isArray(e)) {
                for (var s = 0; s < e.length; s += 1)
            ...
            this.params.virtual.cache && (n = this.virtual.cache,
            r = {},
            Object.keys(n).forEach(function(e) {
                var t = n[e]
      ...
      , $ = {
        handle: function(e) {
            ...
            var r = n.keyCode || n.charCode
              ...
              , u = 38 === r
              , e = 40 === r;
            if (!t.allowSlideNext && (t.isHorizontal() && d || t.isVertical() && e || o))
                return !1;
            if (!t.allowSlidePrev && (t.isHorizontal() && l || t.isVertical() && u || s))
                return !1;
            if (!(n.shiftKey || n.altKey || n.ctrlKey || n.metaKey || v.activeElement && v.activeElement.nodeName && ("input" === v.activeElement.nodeName.toLowerCase() || "textarea" === v.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (s || o || l || d || u || e)) {
                    ...
                    for (var f = [[a.left, a.top], [a.left + t.width, a.top], [a.left, a.top + t.height], [a.left + t.width, a.top + t.height]], m = 0; m < f.length; m += 1) {
                        var g = f[m];
                ...
                t.isHorizontal() ? ((s || o || l || d) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                ((o || d) && !i || (s || l) && i) && t.slideNext(),
                ((s || l) && !i || (o || d) && i) && t.slidePrev()) : ((s || o || u || e) && (n.preventDefault ? n.preventDefault() : n.returnValue = !1),
                (o || e) && t.slideNext(),
                (s || u) && t.slidePrev()),
                t.emit("keyPress", r)
            }
        ...
        enable: function() {
            this.keyboard.enabled || (T(v).on("keydown", this.keyboard.handle),
            this.keyboard.enabled = !0)
        },
        disable: function() {
            this.keyboard.enabled && (T(v).off("keydown", this.keyboard.handle),
    ...
    var q = {
        ...
        recentWheelEvents: [],
        event: function() {
            return -1 < G.navigator.userAgent.indexOf("firefox") ? "DOMMouseScroll" : ((i = (t = "onwheel")in v) || ((e = v.createElement("div")).setAttribute(t, "return;"),
            i = "function" == typeof e[t]),
            !i && v.implementation && v.implementation.hasFeature && !0 !== v.implementation.hasFeature("", "") && (i = v.implementation.hasFeature("Events.wheel", "3.0")),
            i ? "wheel" : "mousewheel");
            var e, t, i
        },
        ...
        handle: function(e) {
            ...
            var r = i.$el;
            if ("container" !== i.params.mousewheel.eventsTarged && (r = T(i.params.mousewheel.eventsTarged)),
            ...
            i.params.freeMode) {
                ...
                if (!r) {
                    ...
                    var l, d, u = i.getTranslate() + a * n.sensitivity, s = i.isBeginning, n = i.isEnd;
                    ...
                    n = l[0],
                    l.push(o),
                    s && (o.delta > s.delta || o.direction !== s.direction) ? l.splice(0) : 15 <= l.length && o.time - n.time < 500 && 1 <= n.delta - o.delta && o.delta <= 6 && (d = 0 < a ? .8 : .2,
                ...
                if (a.push(u),
                (!e || u.direction !== e.direction || u.delta > e.delta || u.time > e.time + 150) && i.mousewheel.animateSlider(u),
                i.mousewheel.releaseScroll(u))
                    return !0
            }
        ...
        animateSlider: function(e) {
            var t = this;
            return 6 <= e.delta && U.now() - t.mousewheel.lastScrollTime < 60 || (e.direction < 0 ? t.isEnd && !t.params.loop || t.animating || (t.slideNext(),
        ...
        enable: function() {
            ...
            if (e.mousewheel.enabled)
                return !1;
            var i = e.$el;
            return "container" !== e.params.mousewheel.eventsTarged && (i = T(e.params.mousewheel.eventsTarged)),
      ...
      , F = {
        update: function() {
            ...
            if (n.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                var r, i = (e.virtual && e.params.virtual.enabled ? e.virtual : e).slides.length, a = e.pagination.$el, s = e.params.loop ? Math.ceil((i - 2 * e.loopedSlides) / e.params.slidesPerGroup) : e.snapGrid.length;
                ...
                "bullets" === n.type && e.pagination.bullets && 0 < e.pagination.bullets.length) {
                    var o, l, d, u, c, h = e.pagination.bullets;
                    if (n.dynamicBullets && (e.pagination.bulletSize = h.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    a.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (n.dynamicMainBullets + 4) + "px"),
                    1 < n.dynamicMainBullets && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += r - e.previousIndex,
                    ...
                    h.removeClass(n.bulletActiveClass + " " + n.bulletActiveClass + "-next " + n.bulletActiveClass + "-next-next " + n.bulletActiveClass + "-prev " + n.bulletActiveClass + "-prev-prev " + n.bulletActiveClass + "-main"),
                    1 < a.length)
                        h.each(function(e, t) {
                            var i = T(t)
                              , t = i.index();
                            t === r && i.addClass(n.bulletActiveClass),
                            n.dynamicBullets && (o <= t && t <= l && i.addClass(n.bulletActiveClass + "-main"),
                            t === o && i.prev().addClass(n.bulletActiveClass + "-prev").prev().addClass(n.bulletActiveClass + "-prev-prev"),
                            t === l && i.next().addClass(n.bulletActiveClass + "-next").next().addClass(n.bulletActiveClass + "-next-next"))
                        });
                    else {
                        var p = h.eq(r)
                          , f = p.index();
                        ...
                        n.dynamicBullets) {
                            for (var i = h.eq(o), p = h.eq(l), m = o; m <= l; m += 1)
                                h.eq(m).addClass(n.bulletActiveClass + "-main");
                            if (e.params.loop)
                                if (f >= h.length - n.dynamicMainBullets) {
                                    for (var g = n.dynamicMainBullets; 0 <= g; --g)
                                        h.eq(h.length - g).addClass(n.bulletActiveClass + "-main");
                                    h.eq(h.length - n.dynamicMainBullets - 1).addClass(n.bulletActiveClass + "-prev")
                                } else
                                    i.prev().addClass(n.bulletActiveClass + "-prev").prev().addClass(n.bulletActiveClass + "-prev-prev"),
                    ...
                    n.dynamicBullets && (c = Math.min(h.length, n.dynamicMainBullets + 4),
                    u = (e.pagination.bulletSize * c - e.pagination.bulletSize) / 2 - d * e.pagination.bulletSize,
                    c = t ? "right" : "left",
                    h.css(e.isHorizontal() ? c : "top", u + "px"))
                }
                "fraction" === n.type && (a.find("." + n.currentClass).text(n.formatFractionCurrent(r + 1)),
                a.find("." + n.totalClass).text(n.formatFractionTotal(s))),
                "progressbar" === n.type && (d = n.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical",
                t = (r + 1) / s,
                u = c = 1,
                "horizontal" === d ? c = t : u = t,
                a.find("." + n.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + c + ") scaleY(" + u + ")").transition(e.params.speed)),
        ...
        init: function() {
            ...
            !i.el || 0 !== (e = T(i.el)).length && (t.params.uniqueNavElements && "string" == typeof i.el && 1 < e.length && (e = t.$el.find(i.el)),
      ...
      , V = {
        setTranslate: function() {
            var e, t, i, n, r, a, s, o;
            this.params.scrollbar.el && this.scrollbar.el && (s = this.scrollbar,
            e = this.rtlTranslate,
            o = this.progress,
            t = s.dragSize,
            i = s.trackSize,
            ...
            o = (i - (s = t)) * o,
            e ? 0 < (o = -o) ? (s = t - o,
            o = 0) : i < -o + t && (s = i + o) : o < 0 ? (s = t + o,
            o = 0) : i < o + t && (s = i - o),
            this.isHorizontal() ? (n.transform("translate3d(" + o + "px, 0, 0)"),
        ...
        enableDraggable: function() {
            ...
            a.params.scrollbar.el && (n = a.scrollbar,
            e = a.touchEventsTouch,
            t = a.touchEventsDesktop,
            r = a.params,
            i = n.$el[0],
            n = !(!x.passiveListener || !r.passiveListeners) && {
                passive: !1,
                capture: !1
            },
            r = !(!x.passiveListener || !r.passiveListeners) && {
                passive: !0,
                capture: !1
            },
            x.touch ? (i.addEventListener(e.start, a.scrollbar.onDragStart, n),
            i.addEventListener(e.move, a.scrollbar.onDragMove, n),
            i.addEventListener(e.end, a.scrollbar.onDragEnd, r)) : (i.addEventListener(t.start, a.scrollbar.onDragStart, n),
            v.addEventListener(t.move, a.scrollbar.onDragMove, n),
            v.addEventListener(t.end, a.scrollbar.onDragEnd, r)))
        },
        disableDraggable: function() {
            ...
            x.touch ? (i.removeEventListener(e.start, a.scrollbar.onDragStart, n),
            i.removeEventListener(e.move, a.scrollbar.onDragMove, n),
            i.removeEventListener(e.end, a.scrollbar.onDragEnd, r)) : (i.removeEventListener(t.start, a.scrollbar.onDragStart, n),
            v.removeEventListener(t.move, a.scrollbar.onDragMove, n),
            v.removeEventListener(t.end, a.scrollbar.onDragEnd, r)))
        },
        init: function() {
            var e, t, i, n;
            ...
            this.params.uniqueNavElements && "string" == typeof t.el && 1 < i.length && 1 === n.find(t.el).length && (i = n.find(t.el)),
            0 === (n = i.find("." + this.params.scrollbar.dragClass)).length && (n = T('<div class="' + this.params.scrollbar.dragClass + '"></div>'),
            i.append(n)),
            U.extend(e, {
                $el: i,
                el: i[0],
      ...
      , Y = {
        setTransform: function(e, t) {
            ...
            n[0].style.opacity = i),
            null == e ? n.transform("translate3d(" + s + ", " + o + ", 0px)") : (t = e - (e - 1) * (1 - Math.abs(t)),
            n.transform("translate3d(" + s + ", " + o + ", 0px) scale(" + t + ")"))
        },
        setTranslate: function() {
            var n = this
              , e = n.$el
      ...
      , X = {
        ...
        onGestureStart: function(e) {
            ...
            !x.gestures) {
                ...
                n.scaleStart = X.getDistanceBetweenTouches(e)
            }
            n.$slideEl && n.$slideEl.length || (n.$slideEl = T(e.target).closest("." + this.params.slideClass),
        ...
        onGestureChange: function(e) {
            ...
            if (!x.gestures) {
                ...
                n.scaleMove = X.getDistanceBetweenTouches(e)
            }
            n.$imageEl && 0 !== n.$imageEl.length && (x.gestures ? i.scale = e.scale * i.currentScale : i.scale = n.scaleMove / n.scaleStart * i.currentScale,
        ...
        onTouchStart: function(e) {
            var t = this.zoom
              , i = t.gesture
              , t = t.image;
            i.$imageEl && 0 !== i.$imageEl.length && (t.isTouched || (I.android && e.cancelable && e.preventDefault(),
            t.isTouched = !0,
        ...
        onTouchEnd: function() {
            ...
            if (t.$imageEl && 0 !== t.$imageEl.length) {
                ...
                0 !== n.y && (a = Math.abs((s - i.currentY) / n.y));
                a = Math.max(r, a);
                i.currentX = o,
                i.currentY = s;
                s = i.width * e.scale,
        ...
        in: function(e) {
            var t, i, n, r = this.zoom, a = this.params.zoom, s = r.gesture, o = r.image;
            ...
            s.$imageEl && 0 !== s.$imageEl.length && (s.$slideEl.addClass("" + a.zoomedSlideClass),
            o = void 0 === o.touchesStart.x && e ? (n = ("touchend" === e.type ? e.changedTouches[0] : e).pageX,
            ("touchend" === e.type ? e.changedTouches[0] : e).pageY) : (n = o.touchesStart.x,
            o.touchesStart.y),
            r.scale = s.$imageWrapEl.attr("data-swiper-zoom") || a.maxRatio,
            r.currentScale = s.$imageWrapEl.attr("data-swiper-zoom") || a.maxRatio,
            e ? (a = s.$slideEl[0].offsetWidth,
        ...
        enable: function() {
            var e, t, i, n = this, r = n.zoom;
            r.enabled || (r.enabled = !0,
            e = !("touchstart" !== n.touchEvents.start || !x.passiveListener || !n.params.passiveListeners) && {
                passive: !0,
                capture: !1
            },
            t = !x.passiveListener || {
            ...
            x.gestures ? (n.$wrapperEl.on("gesturestart", i, r.onGestureStart, e),
            n.$wrapperEl.on("gesturechange", i, r.onGestureChange, e),
            n.$wrapperEl.on("gestureend", i, r.onGestureEnd, e)) : "touchstart" === n.touchEvents.start && (n.$wrapperEl.on(n.touchEvents.start, i, r.onGestureStart, e),
        ...
        disable: function() {
            ...
            i = "." + n.params.slideClass,
            x.gestures ? (n.$wrapperEl.off("gesturestart", i, r.onGestureStart, e),
            n.$wrapperEl.off("gesturechange", i, r.onGestureChange, e),
            n.$wrapperEl.off("gestureend", i, r.onGestureEnd, e)) : "touchstart" === n.touchEvents.start && (n.$wrapperEl.off(n.touchEvents.start, i, r.onGestureStart, e),
        ...
        loadInSlide: function(e, l) {
            ...
            0 !== e.length && e.each(function(e, t) {
                ...
                u.loadImage(i[0], r || n, a, s, !1, function() {
                    ...
                    i.removeAttr("data-background")) : (a && (i.attr("srcset", a),
                    ...
                    u.params.loop && l && (t = d.attr("data-swiper-slide-index"),
                    d.hasClass(u.params.slideDuplicateClass) ? (e = u.$wrapperEl.children('[data-swiper-slide-index="' + t + '"]:not(.' + u.params.slideDuplicateClass + ")"),
                    u.lazy.loadInSlide(e.index(), !1)) : (t = u.$wrapperEl.children("." + u.params.slideDuplicateClass + '[data-swiper-slide-index="' + t + '"]'),
        ...
        load: function() {
            ...
            if (s.loadPrevNext)
                if (1 < o || s.loadPrevNextAmount && 1 < s.loadPrevNextAmount) {
                    for (var c = s.loadPrevNextAmount, s = o, h = Math.min(e + s + Math.max(c, s), r.length), c = Math.max(e - Math.max(s, c), 0), p = e + o; p < h; p += 1)
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(a))
                for (var o = 0; o < a.length; o += 1)
                    a[o] !== t && a[o]instanceof B && s(a[o]);
            else
                a instanceof B && t !== a && s(a)
        },
        setTransition: function(t, e) {
            ...
            if (Array.isArray(r))
                for (i = 0; i < r.length; i += 1)
                    r[i] !== e && r[i]instanceof B && a(r[i]);
            else
                r instanceof B && e !== r && a(r)
        }
    }
      , J = {
        ...
        updateNavigation: function() {
            var e, t, i = this;
            !i.params.loop && i.navigation && (e = (t = i.navigation).$nextEl,
            (t = t.$prevEl) && 0 < t.length && (i.isBeginning ? (i.a11y.disableEl(t),
            i.a11y.makeElNotFocusable(t)) : (i.a11y.enableEl(t),
            i.a11y.makeElFocusable(t))),
            e && 0 < e.length && (i.isEnd ? (i.a11y.disableEl(e),
            i.a11y.makeElNotFocusable(e)) : (i.a11y.enableEl(e),
      ...
      , Z = {
        init: function() {
            if (this.params.history) {
                ...
                this.params.history.replaceState || G.addEventListener("popstate", this.history.setHistoryPopState))
            }
        },
        destroy: function() {
        ...
        setHistory: function(e, t) {
            ...
            G.location.pathname.includes(e) || (t = e + "/" + t),
            (e = G.history.state) && e.value === t || (this.params.history.replaceState ? G.history.replaceState({
                value: t
            }, null, t) : G.history.pushState({
                value: t
            }, null, t)))
        },
        slugify: function(e) {
        ...
        scrollToSlide: function(e, t, i) {
            if (t)
                for (var n = 0, r = this.slides.length; n < r; n += 1) {
                    ...
                    Z.slugify(a.attr("data-history")) !== t || a.hasClass(this.params.slideDuplicateClass) || (a = a.index(),
                    this.slideTo(a, e, i))
                }
            else
                this.slideTo(0, e, i)
      ...
      , ee = {
        ...
        setHash: function() {
            var e;
            this.hashNavigation.initialized && this.params.hashNavigation.enabled && (this.params.hashNavigation.replaceState && G.history && G.history.replaceState ? G.history.replaceState(null, null, "#" + this.slides.eq(this.activeIndex).attr("data-hash") || "") : (e = (e = this.slides.eq(this.activeIndex)).attr("data-hash") || e.attr("data-history"),
            v.location.hash = e || ""),
            this.emit("hashSet"))
        },
        init: function() {
            ...
            if (!(!e.params.hashNavigation.enabled || e.params.history && e.params.history.enabled)) {
                ...
                if (t)
                    for (var i = 0, n = e.slides.length; i < n; i += 1) {
                        var r = e.slides.eq(i);
                        (r.attr("data-hash") || r.attr("data-history")) !== t || r.hasClass(e.params.slideDuplicateClass) || (r = r.index(),
                        e.slideTo(r, 0, e.params.runCallbacksOnInit, !0))
                    }
                e.params.hashNavigation.watchState && T(G).on("hashchange", e.hashNavigation.onHashCange)
            }
        },
        destroy: function() {
            this.params.hashNavigation.watchState && T(G).off("hashchange", this.hashNavigation.onHashCange)
        }
    }
      , te = {
        run: function() {
      ...
      , ie = {
        ...
        setTransition: function(e) {
            var i, n = this, t = n.slides, r = n.$wrapperEl;
            t.transition(e),
      ...
      , ne = {
        setTranslate: function() {
            ...
            d.shadow && (u ? (0 === (e = n.find(".swiper-cube-shadow")).length && (e = T('<div class="swiper-cube-shadow"></div>'),
            n.append(e)),
            e.css({
                height: a + "px"
            ...
            for (var p = 0; p < r.length; p += 1) {
                ...
                f.transform(x),
                d.slideShadows && (m = u ? f.find(".swiper-slide-shadow-left") : f.find(".swiper-slide-shadow-top"),
                x = u ? f.find(".swiper-slide-shadow-right") : f.find(".swiper-slide-shadow-bottom"),
                0 === m.length && (m = T('<div class="swiper-slide-shadow-' + (u ? "left" : "top") + '"></div>'),
                f.append(m)),
                0 === x.length && (x = T('<div class="swiper-slide-shadow-' + (u ? "right" : "bottom") + '"></div>'),
                f.append(x)),
            ...
            d.shadow && (u ? e.transform("translate3d(0px, " + (a / 2 + d.shadowOffset) + "px, " + -a / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + d.shadowScale + ")") : (C = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
      ...
      , re = {
        setTranslate: function() {
            for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
                ...
                var a, s, o = -180 * r, l = 0, d = -n[0].swiperSlideOffset, u = 0;
                this.isHorizontal() ? t && (o = -o) : (u = d,
                l = -o,
                o = d = 0),
                n[0].style.zIndex = -Math.abs(Math.round(r)) + e.length,
                this.params.flipEffect.slideShadows && (a = this.isHorizontal() ? n.find(".swiper-slide-shadow-left") : n.find(".swiper-slide-shadow-top"),
                s = this.isHorizontal() ? n.find(".swiper-slide-shadow-right") : n.find(".swiper-slide-shadow-bottom"),
                0 === a.length && (a = T('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'),
                n.append(a)),
                0 === s.length && (s = T('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'),
                n.append(s)),
        ...
        setTransition: function(e) {
            var i, n = this, t = n.slides, r = n.activeIndex, a = n.$wrapperEl;
      ...
      , ae = {
        setTranslate: function() {
            for (var e = this.width, t = this.height, i = this.slides, n = this.$wrapperEl, r = this.slidesSizesGrid, a = this.params.coverflowEffect, s = this.isHorizontal(), o = this.translate, l = s ? e / 2 - o : t / 2 - o, d = s ? a.rotate : -a.rotate, u = a.depth, c = 0, h = i.length; c < h; c += 1) {
                ...
                Math.abs(v) < .001 && (v = 0),
                Math.abs(b) < .001 && (b = 0);
                g = "translate3d(" + f + "px," + w + "px," + y + "px)  rotateX(" + v + "deg) rotateY(" + g + "deg) scale(" + b + ")";
                p.transform(g),
                p[0].style.zIndex = 1 - Math.abs(Math.round(m)),
                a.slideShadows && (b = s ? p.find(".swiper-slide-shadow-left") : p.find(".swiper-slide-shadow-top"),
                g = s ? p.find(".swiper-slide-shadow-right") : p.find(".swiper-slide-shadow-bottom"),
                0 === b.length && (b = T('<div class="swiper-slide-shadow-' + (s ? "left" : "top") + '"></div>'),
                p.append(b)),
                0 === g.length && (g = T('<div class="swiper-slide-shadow-' + (s ? "right" : "bottom") + '"></div>'),
                p.append(g)),
      ...
      , se = {
        ...
        onThumbClick: function() {
            var e, t, i, n = this, r = n.thumbs.swiper;
            r && (t = r.clickedIndex,
            (e = r.clickedSlide) && T(e).hasClass(n.params.thumbs.slideThumbActiveClass) || null != t && (i = r.params.loop ? parseInt(T(r.clickedSlide).attr("data-swiper-slide-index"), 10) : t,
            n.params.loop && (e = n.activeIndex,
            n.slides.eq(e).hasClass(n.params.slideDuplicateClass) && (n.loopFix(),
            n._clientLeft = n.$wrapperEl[0].clientLeft,
            e = n.activeIndex),
            r = n.slides.eq(e).prevAll('[data-swiper-slide-index="' + i + '"]').eq(0).index(),
            t = n.slides.eq(e).nextAll('[data-swiper-slide-index="' + i + '"]').eq(0).index(),
        ...
        update: function(e) {
            var t = this
              , i = t.thumbs.swiper;
            if (i) {
                var n, r, a, s = "auto" === i.params.slidesPerView ? i.slidesPerViewDynamic() : i.params.slidesPerView, o = t.params.thumbs.autoScrollOffset, l = o && !i.params.loop;
                t.realIndex === i.realIndex && !l || (n = i.activeIndex,
                a = i.params.loop ? (i.slides.eq(n).hasClass(i.params.slideDuplicateClass) && (i.loopFix(),
                i._clientLeft = i.$wrapperEl[0].clientLeft,
                n = i.activeIndex),
                a = i.slides.eq(n).prevAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index(),
                r = i.slides.eq(n).nextAll('[data-swiper-slide-index="' + t.realIndex + '"]').eq(0).index(),
                r = void 0 === a ? r : void 0 === r ? a : r - n == n - a ? n : r - n < n - a ? r : a,
                t.activeIndex > t.previousIndex ? "next" : "prev") : (r = t.realIndex) > t.previousIndex ? "next" : "prev",
                l && (r += "next" === a ? o : -1 * o),
                ...
                i.params.loop || i.params.virtual && i.params.virtual.enabled)
                    ...
                    for (var h = 0; h < d; h += 1)
                        i.slides.eq(t.realIndex + h).addClass(u)
            }
        }
    }
      , c = [d, u, h, p, D, i, c, {
        ...
        on: {
            ...
            click: function(e) {
                var t, i = this, n = i.navigation, r = n.$nextEl, n = n.$prevEl;
                !i.params.navigation.hideOnClick || T(e.target).is(n) || T(e.target).is(r) || (r ? t = r.hasClass(i.params.navigation.hiddenClass) : n && (t = n.hasClass(i.params.navigation.hiddenClass)),
        ...
        on: {
            ...
            click: function(e) {
                var t = this;
                t.params.pagination.el && t.params.pagination.hideOnClick && 0 < t.pagination.$el.length && !T(e.target).hasClass(t.params.pagination.bulletClass) && (!0 === t.pagination.$el.hasClass(t.params.pagination.hiddenClass) ? t.emit("paginationShow", t) : t.emit("paginationHide", t),
        ...
        create: function() {
            ...
            Object.defineProperty(n.zoom, "scale", {
                ...
                set: function(e) {
                    var t, i;
                    r !== e && (t = n.zoom.gesture.$imageEl ? n.zoom.gesture.$imageEl[0] : void 0,
...
function(e) {
    ...
    var l, P, n, r, o, a, m, N, z, g, h, d, u, c, p, f, v, y, b, w, x, C, E, T, S, _, k, M, B, s, D, I, O, L, j, H, R, $, q, W, F, V, Y, X, G, U, Q, K, J, Z, t, ee, te, ie, ne, re, ae, e, i, se;
    ...
    e || (i ? require("jquery-mousewheel")(A) : A.event.special.mousewheel || A("head").append(decodeURI("%3Cscript src=" + se + "//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js%3E%3C/script%3E"))),
    l = "mCustomScrollbar",
    P = "mCS",
    n = ".mCustomScrollbar",
    r = {
    ...
    h = {
        init: function(s) {
            ...
            if (s.live) {
                ...
                a[t] = setTimeout(function() {
                    ...
                    "once" === s.live && i.length && c(t)
                }, 500)
            } else
                c(t);
            return s.setWidth = s.set_width || s.setWidth,
        ...
        update: function(e, s) {
            ...
            return A(e).each(function() {
                ...
                "x" !== t.axis && (e.overflowed[0] ? n[0].height() > n[0].parent().height() ? S.call(this) : (K(a, r[0].toString(), {
                    dir: "y",
                    dur: 0,
                    overwrite: "none"
                }),
                e.contentReset.y = null) : (S.call(this),
                "y" === t.axis ? k.call(this) : "yx" === t.axis && e.overflowed[1] && K(a, r[1].toString(), {
                    dir: "x",
                    dur: 0,
                    overwrite: "none"
                }))),
                "y" !== t.axis && (e.overflowed[1] ? n[1].width() > n[1].parent().width() ? S.call(this) : (K(a, r[1].toString(), {
                    dir: "x",
                    dur: 0,
                    overwrite: "none"
                }),
                e.contentReset.x = null) : (S.call(this),
                "x" === t.axis ? k.call(this) : "yx" === t.axis && e.overflowed[0] && K(a, r[0].toString(), {
                    dir: "y",
                    dur: 0,
                    overwrite: "none"
                }))),
                s && e && (2 === s && t.callbacks.onImageLoad && "function" == typeof t.callbacks.onImageLoad ? t.callbacks.onImageLoad.call(this) : 3 === s && t.callbacks.onSelectorChange && "function" == typeof t.callbacks.onSelectorChange ? t.callbacks.onSelectorChange.call(this) : t.callbacks.onUpdate && "function" == typeof t.callbacks.onUpdate && t.callbacks.onUpdate.call(this)),
                U.call(this)))
            })
        },
        scrollTo: function(s, o) {
            if (void 0 !== s && null != s) {
                ...
                return A(e).each(function() {
                    ...
                    n[0] = G.call(this, n[0], "y"),
                    n[1] = G.call(this, n[1], "x"),
    ...
    v = function() {
        ...
        e.addClass(l + " _" + P + "_" + t.idx + n + r).wrapInner("<div id='mCSB_" + t.idx + "' class='mCustomScrollBox mCS-" + i.theme + " " + a + "'><div id='mCSB_" + t.idx + "_container' class='mCSB_container' style='position:relative; top:" + i.setTop + "; left:" + i.setLeft + ";' dir='" + t.langDir + "' /></div>");
        r = A("#mCSB_" + t.idx),
        a = A("#mCSB_" + t.idx + "_container");
        ...
        r.addClass("mCSB_outside").after(s)) : (r.addClass("mCSB_inside").append(s),
        a.wrap(o)),
        w.call(this);
    ...
    b = function() {
        ...
        3 === t.advanced.autoExpandHorizontalScroll || 2 !== t.advanced.autoExpandHorizontalScroll && e > i.parent().width() ? i.css({
            width: e,
            "min-width": "100%",
            "overflow-x": "inherit"
        }) : i.css({
    ...
    S = function() {
        ...
        Q(e),
        ("x" !== i.axis && !t.overflowed[0] || "y" === i.axis && t.overflowed[0]) && (a[0].add(r).css("top", 0),
        K(e, "_resetY")),
    ...
    k = function() {
        ...
        t.bindEvents && (A(document).add(A(!j() || top.document)).unbind("." + n),
        a.each(function() {
            A(this).unbind("." + n)
        }),
    ...
    M = function(e) {
        ...
        "x" !== n.axis && (i.overflowed[0] && !e ? (s[0].add(r[0]).add(s[0].children("a")).css("display", "block"),
        a.removeClass(g[8] + " " + g[10])) : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && r[0].css("display", "none"),
        a.removeClass(g[10])) : (s[0].css("display", "none"),
        a.addClass(g[10])),
        a.addClass(g[8]))),
        "y" !== n.axis && (i.overflowed[1] && !e ? (s[1].add(r[1]).add(s[1].children("a")).css("display", "block"),
        a.removeClass(g[9] + " " + g[11])) : (n.alwaysShowScrollbar ? (2 !== n.alwaysShowScrollbar && r[1].css("display", "none"),
        a.removeClass(g[11])) : (s[1].css("display", "none"),
        a.addClass(g[11])),
        a.addClass(g[9]))),
    ...
    ,
    s = function() {
        var a, r, s, o = A(this), l = o.data(P), d = l.opt, e = "mCS_" + l.idx, u = ["mCSB_" + l.idx + "_dragger_vertical", "mCSB_" + l.idx + "_dragger_horizontal"], c = A("#mCSB_" + l.idx + "_container"), t = A("#" + u[0] + ",#" + u[1]), i = d.advanced.releaseDraggableSelectors ? t.add(A(d.advanced.releaseDraggableSelectors)) : t, n = d.advanced.extraDraggableSelectors ? A(!j() || top.document).add(A(d.advanced.extraDraggableSelectors)) : A(!j() || top.document);
        function h(e, t, i, n) {
            var r;
            c[0].idleTimer = d.scrollInertia < 233 ? 250 : 0,
            i = a.attr("id") === u[1] ? (r = "x",
            (a[0].offsetLeft - t + n) * l.scrollRatio.x) : (r = "y",
            (a[0].offsetTop - e + i) * l.scrollRatio.y),
            K(o, i.toString(), {
                dir: r,
                drag: !0
            })
        ...
        A(document).add(n).bind("mousemove." + e + " pointermove." + e + " MSPointerMove." + e, function(e) {
            var t, i;
            a && (i = a.offset(),
            t = B(e)[0] - i.top,
            i = B(e)[1] - i.left,
            ...
            a && (E(a, "active", d.autoExpandScrollbar),
            a = null),
            N = !1,
    ...
    ,
    D = function() {
        var s, o, l, a, d, u, c, h, p, f, m, g, v = A(this), y = v.data(P), b = y.opt, e = "mCS_" + y.idx, w = A("#mCSB_" + y.idx), x = A("#mCSB_" + y.idx + "_container"), C = [A("#mCSB_" + y.idx + "_dragger_vertical"), A("#mCSB_" + y.idx + "_dragger_horizontal")], T = [], E = [], S = 0, _ = "yx" === b.axis ? "none" : "all", k = [], t = x.find("iframe"), i = ["touchstart." + e + " pointerdown." + e + " MSPointerDown." + e, "touchmove." + e + " pointermove." + e + " MSPointerMove." + e, "touchend." + e + " pointerup." + e + " MSPointerUp." + e], M = void 0 !== document.body.style.touchAction && "" !== document.body.style.touchAction;
        function n(e) {
            var t;
            !ie(e) || N || B(e)[2] ? z = 0 : (g = m = 0,
            s = z = 1,
        ...
        function r(e) {
            var t, i, n, r, a;
            !ie(e) || N || B(e)[2] || (b.documentTouchScroll || e.preventDefault(),
            e.stopImmediatePropagation(),
            g && !m || s && (c = Z(),
            n = w.offset(),
            t = B(e)[0] - n.top,
            ...
            y.overflowed[0] && (r = C[0].parent().height() - C[0].height(),
            r = 0 < o - t && t - o > -(r * y.scrollRatio.y) && (2 * k[3] < k[2] || "yx" === b.axis)),
            y.overflowed[1] && (a = C[1].parent().width() - C[1].width(),
            a = 0 < l - i && i - l > -(a * y.scrollRatio.x) && (2 * k[2] < k[3] || "yx" === b.axis)),
            r || a ? (M || e.preventDefault(),
            m = 1) : (g = 1,
            v.addClass("mCS_touch_action")),
            M && e.preventDefault(),
            p = "yx" === b.axis ? [o - t, l - i] : "x" === b.axis ? [null, l - i] : [o - t, null],
            x[0].idleTimer = 250,
            y.overflowed[0] && L(p[0], S, n, "y", "all", !0),
            y.overflowed[1] && L(p[1], S, n, "x", _, !0)))
        }
        function D(e) {
            var t;
            !ie(e) || N || B(e)[2] ? z = 0 : (z = 1,
            e.stopImmediatePropagation(),
            Q(v),
            u = Z(),
            t = w.offset(),
        ...
        function I(e) {
            ...
            e = [Math.abs(x[0].offsetTop) - h[0] * O(r[0] / f[0], f[0]), Math.abs(x[0].offsetLeft) - h[1] * O(r[1] / f[1], f[1])],
            ...
            p[0] = e < r[0] ? p[0] : 0,
            p[1] = e < r[1] ? p[1] : 0,
            y.overflowed[0] && L(p[0], f[0], i, "y", _, !1),
            y.overflowed[1] && L(p[1], f[1], i, "x", _, !1)))
        }
        function O(e, t) {
        ...
        x.bind(i[0], function(e) {
            n(e)
        }).bind(i[1], function(e) {
            r(e)
        }),
        w.bind(i[0], function(e) {
            D(e)
        }).bind(i[2], function(e) {
            I(e)
        }),
        t.length && t.each(function() {
            A(this).bind("load", function() {
                j(this) && A(this.contentDocument || this.contentWindow.document).bind(i[0], function(e) {
                    n(e),
                    D(e)
                }).bind(i[1], function(e) {
                    r(e)
    ...
    ,
    I = function() {
        var n, r = A(this), a = r.data(P), s = a.opt, o = a.sequential, e = "mCS_" + a.idx, l = A("#mCSB_" + a.idx + "_container"), d = l.parent();
        function u(e, t, i) {
            o.type = i && n ? "stepped" : "stepless",
            o.scrollAmount = 10,
            Y(r, e, t, "mcsLinearOut", i ? 60 : null)
        }
        l.bind("mousedown." + e, function(e) {
            ...
            var t, i;
            !z && n && (window.getSelection ? window.getSelection().toString() : document.selection && "Control" != document.selection.type && document.selection.createRange().text) && (i = l.offset(),
            t = B(e)[0] - i.top + l[0].offsetTop,
            i = B(e)[1] - i.left + l[0].offsetLeft,
            0 < t && t < d.height() && 0 < i && i < d.width() ? o.step && u("off", null, "stepped") : ("x" !== s.axis && a.overflowed[0] && (t < 0 ? u("on", 38) : t > d.height() && u("on", 40)),
            "y" !== s.axis && a.overflowed[1] && (i < 0 ? u("on", 37) : i > d.width() && u("on", 39))))
    ...
    O = function() {
        ...
        function i(e, t) {
            var i, n, r, a, s, o, l, d;
            Q(u),
            R(u, e.target) || (i = "auto" !== h.mouseWheel.deltaFactor ? parseInt(h.mouseWheel.deltaFactor) : !(m && e.deltaFactor < 100) && e.deltaFactor || 100,
            n = h.scrollInertia,
            t = "x" === h.axis || "x" === h.mouseWheel.axis ? (r = "x",
            ...
            "y" === h.mouseWheel.axis ? e.deltaY || t : e.deltaX) : (r = "y",
            ...
            e.deltaY || t),
            "y" === r && !c.overflowed[0] || "x" === r && !c.overflowed[1] || ((h.mouseWheel.invert || e.webkitDirectionInvertedFromDevice) && (t = -t),
            h.mouseWheel.normalizeDelta && (t = t < 0 ? -1 : 1),
            (0 < t && 0 !== l || t < 0 && l !== d || h.mouseWheel.preventDefault) && (e.stopImmediatePropagation(),
            e.preventDefault()),
            e.deltaFactor < 5 && !h.mouseWheel.normalizeDelta && (s = e.deltaFactor,
            n = 17),
            K(u, (o - t * s).toString(), {
                dir: r,
                dur: n
        ...
        A(this).data(P) && (u = A(this),
        c = u.data(P),
        h = c.opt,
        e = "mCS_" + c.idx,
        p = A("#mCSB_" + c.idx),
        f = [A("#mCSB_" + c.idx + "_dragger_vertical"), A("#mCSB_" + c.idx + "_dragger_horizontal")],
        (t = A("#mCSB_" + c.idx + "_container").find("iframe")).length && t.each(function() {
            A(this).bind("load", function() {
                j(this) && A(this.contentDocument || this.contentWindow.document).bind("mousewheel." + e, function(e, t) {
                    i(e, t)
                })
            })
        }),
    ...
    ,
    $ = function() {
        var s, o = A(this), l = o.data(P), e = "mCS_" + l.idx, d = A("#mCSB_" + l.idx + "_container"), u = d.parent();
        A(".mCSB_" + l.idx + "_scrollbar ." + g[12]).bind("mousedown." + e + " touchstart." + e + " pointerdown." + e + " MSPointerDown." + e, function(e) {
            N = !0,
            A(e.target).hasClass("mCSB_dragger") || (s = 1)
        }).bind("touchend." + e + " pointerup." + e + " MSPointerUp." + e, function(e) {
            N = !1
        }).bind("click." + e, function(e) {
            if (s && (s = 0,
            A(e.target).hasClass(g[12]) || A(e.target).hasClass("mCSB_draggerRail"))) {
                Q(o);
                var t = A(this)
                ...
                if (0 < t.parent(".mCSB_scrollTools_horizontal").length) {
                    ...
                    var n = "x"
                      ...
                      , a = Math.abs(d[0].offsetLeft) - r * (.9 * u.width())
                } else {
                    if (!l.overflowed[0])
                        return;
                    n = "y",
                    r = e.pageY > i.offset().top ? -1 : 1,
                    a = Math.abs(d[0].offsetTop) - r * (.9 * u.height())
                }
                K(o, a.toString(), {
                    dir: n,
                    scrollEasing: "mcsEaseInOut"
    ...
    q = function() {
        ...
        s.bind("focusin." + t, function(e) {
            ...
            n.is(a.advanced.autoScrollOnFocus) && (Q(r),
            ...
            r[0]._focusTimeout = setTimeout(function() {
                ...
                "x" === a.axis || i[0] || K(r, e[0].toString(), {
                    dir: "y",
                    scrollEasing: "mcsEaseInOut",
                    overwrite: t,
                    dur: 0
                }),
                "y" === a.axis || i[1] || K(r, e[1].toString(), {
                    dir: "x",
                    scrollEasing: "mcsEaseInOut",
                    overwrite: t,
                    dur: 0
    ...
    F = function() {
        ...
        A(t + ">a").bind("contextmenu." + e, function(e) {
            e.preventDefault()
            ...
            te(e)) {
                ...
                switch (s.type = a.scrollButtons.scrollType,
                e.type) {
                case "mousedown":
                case "touchstart":
                case "pointerdown":
                ...
                case "MSPointerOut":
                    ...
                    break;
                case "click":
                    if ("stepped" !== s.type || r.tweenRunning)
                        return;
                    i("on", t)
                }
            }
            function i(e, t) {
                s.scrollAmount = a.scrollButtons.scrollAmount,
                Y(n, e, t)
            }
        })
    }
    ...
    V = function() {
        ...
        function r(e) {
            ...
            case "keydown":
            case "keyup":
                var t, i, n = e.keyCode || e.which, r = "on";
                if ("x" !== l.axis && (38 === n || 40 === n) || "y" !== l.axis && (37 === n || 39 === n)) {
                    if ((38 === n || 40 === n) && !o.overflowed[0] || (37 === n || 39 === n) && !o.overflowed[1])
                        return;
                    "keyup" === e.type && (r = "off"),
                    A(document.activeElement).is(h) || (e.preventDefault(),
                    e.stopImmediatePropagation(),
                    a(r, n))
                } else
                    33 === n || 34 === n ? ((o.overflowed[0] || o.overflowed[1]) && (e.preventDefault(),
                    e.stopImmediatePropagation()),
                    "keyup" === e.type && (Q(s),
                    i = 34 === n ? -1 : 1,
                    i = "x" === l.axis || "yx" === l.axis && o.overflowed[1] && !o.overflowed[0] ? (t = "x",
                    Math.abs(u[0].offsetLeft) - i * (.9 * c.width())) : (t = "y",
                    Math.abs(u[0].offsetTop) - i * (.9 * c.height())),
                    K(s, i.toString(), {
                        dir: t,
                        scrollEasing: "mcsEaseInOut"
                    }))) : 35 !== n && 36 !== n || A(document.activeElement).is(h) || ((o.overflowed[0] || o.overflowed[1]) && (e.preventDefault(),
                    e.stopImmediatePropagation()),
                    "keyup" === e.type && (i = "x" === l.axis || "yx" === l.axis && o.overflowed[1] && !o.overflowed[0] ? (t = "x",
                    35 === n ? Math.abs(c.width() - u.outerWidth(!1)) : 0) : (t = "y",
                    35 === n ? Math.abs(c.height() - u.outerHeight(!1)) : 0),
                    K(s, i.toString(), {
                        dir: t,
                        scrollEasing: "mcsEaseInOut"
                    })))
            ...
            function a(e, t) {
                d.type = l.keyboard.scrollType,
                d.scrollAmount = l.keyboard.scrollAmount,
                "stepped" === d.type && o.tweenRunning || Y(s, e, t)
            }
        }
        i.length && i.each(function() {
            A(this).bind("load", function() {
                j(this) && A(this.contentDocument || this.contentWindow.document).bind(n[0], function(e) {
                    r(e)
                })
            })
        }),
    ...
    Y = function(s, e, t, o, l) {
        ...
        switch (e) {
        case "on":
            if (c.dir = [t === g[16] || t === g[15] || 39 === t || 37 === t ? "x" : "y", t === g[13] || t === g[15] || 38 === t || 37 === t ? -1 : 1],
            Q(s),
            ne(t) && "stepped" === c.type)
                return;
            m(i);
    ...
    X = function(e) {
        ...
        e instanceof Array ? i = 1 < e.length ? [e[0], e[1]] : "x" === t.axis ? [null, e[0]] : [e[0], null] : (i[0] = e.y || (e.x || "x" === t.axis ? null : e),
    ...
    G = function(e, t) {
        if (null != e && void 0 !== e) {
            ...
            case "number":
                ...
                if (-1 !== e.indexOf("-="))
                    return Math.abs(l - parseInt(e.split("-=")[1]));
                if (-1 !== e.indexOf("+=")) {
                ...
                if ("first" !== e && "last" !== e)
                    return A(e).length ? "x" === t ? re(A(e))[1] : re(A(e))[0] : (a.css(d, e),
    ...
    U = function(e) {
        ...
        if (e)
            ...
            void ee(r[0], "autoUpdate");
        function a(e) {
            var t, i, n;
            A(e).hasClass(g[2]) ? o() : ((t = new Image).onload = (i = t,
            n = function() {
                this.onload = null,
                A(e).addClass(g[2]),
                o(2)
        ...
        function o(e) {
            ...
            h.update.call(null, t[0], e)
        }
        !function e() {
            clearTimeout(r[0].autoUpdate);
            if (0 === t.parents("html").length)
                return void (t = null);
            r[0].autoUpdate = setTimeout(function() {
                return n.advanced.updateOnSelectorChange && (i.poll.change.n = s(),
                i.poll.change.n !== i.poll.change.o) ? (i.poll.change.o = i.poll.change.n,
                void o(3)) : n.advanced.updateOnContentResize && (i.poll.size.n = t[0].scrollHeight + t[0].scrollWidth + r[0].offsetHeight + t[0].offsetHeight + t[0].offsetWidth,
                i.poll.size.n !== i.poll.size.o) ? (i.poll.size.o = i.poll.size.n,
                void o(1)) : !n.advanced.updateOnImageLoad || "auto" === n.advanced.updateOnImageLoad && "y" === n.axis || (i.poll.img.n = r.find("img").length,
                i.poll.img.n === i.poll.img.o) ? void ((n.advanced.updateOnSelectorChange || n.advanced.updateOnContentResize || n.advanced.updateOnImageLoad) && e()) : (i.poll.img.o = i.poll.img.n,
    ...
    K = function(r, e, a) {
        var t, i = r.data(P), n = i.opt, s = {
            ...
            onUpdate: !0,
            onComplete: !0
        }, o = [(a = A.extend(s, a)).dur, a.drag ? 0 : a.dur], l = A("#mCSB_" + i.idx), d = A("#mCSB_" + i.idx + "_container"), u = d.parent(), c = n.callbacks.onTotalScrollOffset ? X.call(r, n.callbacks.onTotalScrollOffset) : [0, 0], h = n.callbacks.onTotalScrollBackOffset ? X.call(r, n.callbacks.onTotalScrollBackOffset) : [0, 0];
        if (i.trigger = a.trigger,
        0 === u.scrollTop() && 0 === u.scrollLeft() || (A(".mCSB_" + i.idx + "_scrollbar").css("visibility", "visible"),
        u.scrollTop(0).scrollLeft(0)),
        "_resetY" !== e || i.contentReset.y || (C("onOverflowYNone") && n.callbacks.onOverflowYNone.call(r[0]),
        i.contentReset.y = 1),
        "_resetX" !== e || i.contentReset.x || (C("onOverflowXNone") && n.callbacks.onOverflowXNone.call(r[0]),
        i.contentReset.x = 1),
        "_resetY" !== e && "_resetX" !== e) {
            switch (!i.contentReset.y && r[0].mcs || !i.overflowed[0] || (C("onOverflowY") && n.callbacks.onOverflowY.call(r[0]),
            i.contentReset.x = null),
            !i.contentReset.x && r[0].mcs || !i.overflowed[1] || (C("onOverflowX") && n.callbacks.onOverflowX.call(r[0]),
            i.contentReset.x = null),
            n.snapAmount && (t = n.snapAmount instanceof Array ? "x" === a.dir ? n.snapAmount[1] : n.snapAmount[0] : n.snapAmount,
            s = e,
            u = t,
            t = n.snapOffset,
            e = Math.round(s / u) * u - t),
            a.dir) {
            case "x":
            ...
            r[0].mcs || (T(),
            C("onInit") && n.callbacks.onInit.call(r[0])),
            clearTimeout(d[0].onCompleteTimeout),
            J(p[0], f, Math.round(v[1]), o[1], a.scrollEasing),
            !i.tweenRunning && (0 === m && 0 <= v[0] || m === g[0] && v[0] <= g[0]) || J(d[0], f, Math.round(v[0]), o[0], a.scrollEasing, a.overwrite, {
                onStart: function() {
                    a.callbacks && a.onStart && !i.tweenRunning && (C("onScrollStart") && (T(),
                ...
                onUpdate: function() {
                    a.callbacks && a.onUpdate && C("whileScrolling") && (T(),
                    n.callbacks.whileScrolling.call(r[0]))
                },
                onComplete: function() {
                    var e;
                    a.callbacks && a.onComplete && ("yx" === n.axis && clearTimeout(d[0].onCompleteTimeout),
                    e = d[0].idleTimer || 0,
                    d[0].onCompleteTimeout = setTimeout(function() {
                        C("onScroll") && (T(),
                        n.callbacks.onScroll.call(r[0])),
                        C("onTotalScroll") && v[1] >= g[1] - w && i.cbOffsets[0] && (T(),
                        n.callbacks.onTotalScroll.call(r[0])),
                        C("onTotalScrollBack") && v[1] <= x && i.cbOffsets[1] && (T(),
    ...
    J = function(e, t, i, n, r, a, s) {
        ...
        var o, l, d = (s = s || {}).onStart || function() {}
        , u = s.onUpdate || function() {}
        , c = s.onComplete || function() {}
        , h = Z(), p = 0, f = e.offsetTop, m = e.style, g = e._mTween[t];
        ...
        function y() {
            ...
            p = Z() - h,
            b(),
            p >= g.time && (g.time = p > g.time ? p + o - (p - g.time) : p + o - 1,
            g.time < p + 1 && (g.time = p + 1)),
            g.time < n ? g.id = l(y) : c.call())
        }
        function b() {
            0 < n ? (g.currVal = function(e, t, i, n, r) {
                switch (r) {
                case "linear":
                case "mcsLinear":
                    return i * e / n + t;
        ...
        g.stop = 0,
        "none" === a || null != g.id && (window.requestAnimationFrame ? window.cancelAnimationFrame(g.id) : clearTimeout(g.id),
        g.id = null),
        o = 1e3 / 60,
        g.time = p + o,
        ...
        A.extend(A.expr[":"], {
            ...
            mcsInSight: A.expr[":"].mcsInSight || function(e, t, i) {
                var n = A(e)
                  ...
                  , e = "exact" === i[3] ? [[1, 0], [1, 0]] : [[.9, .1], [.6, .4]];
                if (r.length)
                    return i = [n.outerHeight(!1), n.outerWidth(!1)],
...
function(c, h, v, p) {
    v.swipebox = function(n, e) {
        var s, r, t = {
            ...
            queryStringData: {},
            toggleClassOnLoad: ""
        }, o = this, f = [], a = n.selector, i = navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(Android)|(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i), l = null !== i || h.createTouch !== p || "ontouchstart"in c || "onmsgesturechange"in c || navigator.msMaxTouchPoints, d = !!h.createElementNS && !!h.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, m = c.innerWidth || v(c).width(), u = c.innerHeight || v(c).height(), g = 0;
        o.settings = {},
        v.swipebox.close = function() {
            s.closeSlide()
        }
        ,
        v.swipebox.destroy = function() {
            v(h).off("click.swipebox")
        }
        ,
        ...
        ,
        o.init = function() {
            o.settings = v.extend({}, t, e),
            a = o.settings.selector,
            v.isArray(n) ? (f = n,
            s.target = v(c),
            s.init(o.settings.initialIndexOnArray)) : v(h).on("click.swipebox", a, function(e) {
                return "slide current" !== e.target.parentNode.className && (v.isArray(n) || (s.destroy(),
                r = v(a),
                s.actions()),
                f = [],
                i || (t = "data-rel",
                ...
                i || (t = "rel",
                i = v(this).attr(t)),
                (r = i && "" !== i && "nofollow" !== i ? v(a).filter("[" + t + '="' + i + '"]') : v(a)).each(function() {
                    var e = null
                      , t = null;
                    v(this).attr("title") && (e = v(this).attr("title")),
                    v(this).attr("href") && (t = v(this).attr("href")),
                    f.push({
                        href: t,
                        title: e
                    })
        ...
        s = {
            init: function(e) {
                ...
                this.preloadMedia(e - 1),
                o.settings.afterOpen && o.settings.afterOpen(e)
            },
            build: function() {
                var e;
                v("body").append('<div id="swipebox-overlay">\t\t\t\t\t<div id="swipebox-container">\t\t\t\t\t\t<div id="swipebox-slider"></div>\t\t\t\t\t\t<div id="swipebox-top-bar">\t\t\t\t\t\t\t<div id="swipebox-title"></div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div id="swipebox-bottom-bar">\t\t\t\t\t\t\t<div id="swipebox-arrows">\t\t\t\t\t\t\t\t<a id="swipebox-prev"></a>\t\t\t\t\t\t\t\t<a id="swipebox-next"></a>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<a id="swipebox-close"></a>\t\t\t\t\t</div>\t\t\t</div>'),
                d && !0 === o.settings.useSVG && (e = (e = v("#swipebox-close").css("background-image")).replace("png", "svg"),
                v("#swipebox-prev, #swipebox-next, #swipebox-close").css({
                    "background-image": e
                })),
                i && o.settings.removeBarsOnMobile && v("#swipebox-bottom-bar, #swipebox-top-bar").remove(),
                v.each(f, function() {
                    v("#swipebox-slider").append('<div class="slide"></div>')
                }),
                this.setDim(),
                this.actions(),
                l && this.gesture(),
            ...
            setDim: function() {
                ...
                "onorientationchange"in c ? c.addEventListener("orientationchange", function() {
                    0 === c.orientation ? (e = m,
                    t = u) : 90 !== c.orientation && -90 !== c.orientation || (e = u,
                    t = m)
                }, !1) : (e = c.innerWidth || v(c).width(),
                t = c.innerHeight || v(c).height()),
                i = {
                    width: e,
                    height: t
                },
            ...
            supportTransition: function() {
                for (var e = "transition WebkitTransition MozTransition OTransition msTransition KhtmlTransition".split(" "), t = 0; t < e.length; t++)
                    if (h.createElement("div").style[e[t]] !== p)
                        return e[t];
                return !1
            },
            doCssTrans: function() {
                if (o.settings.useCSS && this.supportTransition())
                    return !0
            },
            gesture: function() {
                var t, i, n, r, a, s, o = this, l = !1, d = !1, u = {}, c = {}, h = v("#swipebox-top-bar, #swipebox-bottom-bar"), p = v("#swipebox-slider");
                h.addClass("visible-bars"),
                o.setTimeout(),
                v("body").bind("touchstart", function(e) {
                    return v(this).addClass("touching"),
                    t = v("#swipebox-slider .slide").index(v("#swipebox-slider .slide.current")),
                    ...
                    v("#swipebox-slider").css({
                        "-webkit-transform": "translate3d(" + g + "%, 0, 0)",
                        transform: "translate3d(" + g + "%, 0, 0)"
                    }),
                    v(".touching").bind("touchmove", function(e) {
                        e.preventDefault(),
                        e.stopPropagation(),
                        c = e.originalEvent.targetTouches[0],
                        d || (a = n,
                        n = c.pageY - u.pageY,
                        (50 <= Math.abs(n) || l) && (e = .75 - Math.abs(n) / p.height(),
                        p.css({
                            top: n + "px"
                        }),
                        p.css({
                        ...
                        i = c.pageX - u.pageX,
                        s = 100 * i / m,
                        !d && !l && 10 <= Math.abs(i) && (v("#swipebox-slider").css({
                            "-webkit-transition": "",
                            transition: ""
                        }),
                        d = !0),
                        d && (0 < i ? 0 === t ? v("#swipebox-overlay").addClass("leftSpringTouch") : (v("#swipebox-overlay").removeClass("leftSpringTouch").removeClass("rightSpringTouch"),
                        v("#swipebox-slider").css({
                            "-webkit-transform": "translate3d(" + (g + s) + "%, 0, 0)",
                            transform: "translate3d(" + (g + s) + "%, 0, 0)"
                        })) : i < 0 && (f.length === t + 1 ? v("#swipebox-overlay").addClass("rightSpringTouch") : (v("#swipebox-overlay").removeClass("leftSpringTouch").removeClass("rightSpringTouch"),
                        v("#swipebox-slider").css({
                            "-webkit-transform": "translate3d(" + (g + s) + "%, 0, 0)",
                            transform: "translate3d(" + (g + s) + "%, 0, 0)"
                        }))))
                    ...
                    s = 100 * i / m,
                    l ? (l = !1,
                    100 <= Math.abs(n) && Math.abs(n) > Math.abs(a) ? (e = 0 < n ? p.height() : -p.height(),
                    p.animate({
                        top: e + "px",
                        opacity: 0
                    }, 300, function() {
                    ...
                    10 <= i && r <= i ? o.getPrev() : i <= -10 && i <= r && o.getNext()) : h.hasClass("visible-bars") ? (o.clearTimeout(),
                    o.hideBars()) : (o.showBars(),
                    o.setTimeout()),
                    v("#swipebox-slider").css({
                        "-webkit-transform": "translate3d(" + g + "%, 0, 0)",
                        transform: "translate3d(" + g + "%, 0, 0)"
                    }),
                    v("#swipebox-overlay").removeClass("leftSpringTouch").removeClass("rightSpringTouch"),
                    v(".touching").off("touchmove").removeClass("touching")
                })
            },
            setTimeout: function() {
                var e;
                0 < o.settings.hideBarsDelay && ((e = this).clearTimeout(),
            ...
            showBars: function() {
                var e = v("#swipebox-top-bar, #swipebox-bottom-bar");
                this.doCssTrans() ? e.addClass("visible-bars") : (v("#swipebox-top-bar").animate({
                    top: 0
                }, 500),
                v("#swipebox-bottom-bar").animate({
                    bottom: 0
                }, 500),
                setTimeout(function() {
            ...
            hideBars: function() {
                var e = v("#swipebox-top-bar, #swipebox-bottom-bar");
                this.doCssTrans() ? e.removeClass("visible-bars") : (v("#swipebox-top-bar").animate({
                    top: "-50px"
                }, 500),
                v("#swipebox-bottom-bar").animate({
                    bottom: "-50px"
            ...
            animBars: function() {
                var e = this
                  , t = v("#swipebox-top-bar, #swipebox-bottom-bar");
                t.addClass("visible-bars"),
                e.setTimeout(),
                v("#swipebox-slider").click(function() {
                ...
                v("#swipebox-bottom-bar").hover(function() {
                    ...
                    0 < o.settings.hideBarsDelay && (t.removeClass("visible-bars"),
                    e.setTimeout())
                })
            },
            keyboard: function() {
                var t = this;
                v(c).bind("keyup", function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
            ...
            actions: function() {
                var t = this
                  , e = "touchend click";
                f.length < 2 ? (v("#swipebox-bottom-bar").hide(),
                p === f[1] && v("#swipebox-top-bar").hide()) : (v("#swipebox-prev").bind(e, function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                    t.getPrev(),
                    t.setTimeout()
                }),
                v("#swipebox-next").bind(e, function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
                    t.getNext(),
                    t.setTimeout()
                })),
                v("#swipebox-close").bind(e, function() {
                    t.closeSlide()
                })
            },
            setSlide: function(e, t) {
                ...
                v("#swipebox-slider .slide").removeClass("current"),
                v("#swipebox-slider .slide").eq(e).addClass("current"),
                this.setTitle(e),
                t && i.fadeIn(),
                v("#swipebox-prev, #swipebox-next").removeClass("disabled"),
                0 === e ? v("#swipebox-prev").addClass("disabled") : e === f.length - 1 && !0 !== o.settings.loopAtEnd && v("#swipebox-next").addClass("disabled")
            },
            openSlide: function(e) {
                v("html").addClass("swipebox-html"),
                l ? (v("html").addClass("swipebox-touch"),
                o.settings.hideCloseButtonOnMobile && v("html").addClass("swipebox-no-close-button")) : v("html").addClass("swipebox-no-touch"),
                v(c).trigger("resize"),
                this.setSlide(e, !0)
            },
            ...
            openMedia: function(e) {
                ...
                e < 0 || e >= f.length)
                    return !1;
                i = v("#swipebox-slider .slide").eq(e),
                this.isVideo(t) ? (i.html(this.getVideo(t)),
                o.settings.afterMedia && o.settings.afterMedia(e)) : (i.addClass("slide-loading"),
                this.loadMedia(t, function() {
                    i.removeClass("slide-loading"),
                    i.html(this),
                    o.settings.afterMedia && o.settings.afterMedia(e)
                }))
            },
            setTitle: function(e) {
                var t = null;
                v("#swipebox-title").empty(),
                f[e] !== p && (t = f[e].title),
                t ? (v("#swipebox-top-bar").show(),
                v("#swipebox-title").append(t)) : v("#swipebox-top-bar").hide()
            },
            isVideo: function(e) {
                if (e)
                    return !!(e.match(/(youtube\.com|youtube-nocookie\.com)\/watch\?v=([a-zA-Z0-9\-_]+)/) || e.match(/vimeo\.com\/([0-9]*)/) || e.match(/youtu\.be\/([a-zA-Z0-9\-_]+)/)) || (0 <= e.toLowerCase().indexOf("swipeboxvideo=1") || void 0)
            },
            parseUri: function(e, t) {
                var i = h.createElement("a")
                  , n = {};
                return i.href = decodeURIComponent(e),
                i.search && (n = JSON.parse('{"' + i.search.toLowerCase().replace("?", "").replace(/&/g, '","').replace(/=/g, '":"') + '"}')),
                v.isPlainObject(t) && (n = v.extend(n, t, o.settings.queryStringData)),
                v.map(n, function(e, t) {
                    if (e && "" < e)
            ...
            getVideo: function(e) {
                ...
                '<iframe width="560" height="315" src="//' + i[1] + "/embed/" + i[2] + "?" + a + '" frameborder="0" allowfullscreen></iframe>') : r ? (a = s.parseUri(e, {
                    autoplay: o.settings.autoplayVideos ? "1" : "0",
                    byline: "0",
                    portrait: "0",
                    color: o.settings.vimeoColor
                }),
                '<iframe width="560" height="315"  src="//player.vimeo.com/video/' + r[1] + "?" + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>') : '<iframe width="560" height="315" src="' + e + '" frameborder="0" allowfullscreen></iframe>';
                return '<div class="swipebox-video-container" style="max-width:' + o.settings.videoMaxWidth + 'px"><div class="swipebox-video">' + t + "</div></div>"
            },
            loadMedia: function(e, t) {
                var i;
                0 === e.trim().indexOf("#") ? t.call(v("<div>", {
                    class: "swipebox-inline-container"
                }).append(v(e).clone().toggleClass(o.settings.toggleClassOnLoad))) : this.isVideo(e) || (i = v("<img>").on("load", function() {
                    t.call(i)
                })).attr("src", e)
            },
            getNext: function() {
                var e, t = v("#swipebox-slider .slide").index(v("#swipebox-slider .slide.current"));
                t + 1 < f.length ? (e = v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src"),
                v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src", e),
                t++,
                this.setSlide(t),
                this.preloadMedia(t + 1),
                o.settings.nextSlide && o.settings.nextSlide(t)) : !0 === o.settings.loopAtEnd ? (e = v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src"),
                v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src", e),
                t = 0,
                this.preloadMedia(t),
                this.setSlide(t),
                this.preloadMedia(t + 1),
                o.settings.nextSlide && o.settings.nextSlide(t)) : (v("#swipebox-overlay").addClass("rightSpring"),
                setTimeout(function() {
            ...
            getPrev: function() {
                var e, t = v("#swipebox-slider .slide").index(v("#swipebox-slider .slide.current"));
                0 < t ? (e = v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src"),
                v("#swipebox-slider .slide").eq(t).contents().find("iframe").attr("src", e),
                t--,
                this.setSlide(t),
                this.preloadMedia(t - 1),
                o.settings.prevSlide && o.settings.prevSlide(t)) : (v("#swipebox-overlay").addClass("leftSpring"),
                setTimeout(function() {
            ...
            closeSlide: function() {
                v("html").removeClass("swipebox-html"),
                v("html").removeClass("swipebox-touch"),
                v(c).trigger("resize"),
                this.destroy()
            },
            destroy: function() {
                v(c).unbind("keyup"),
                v("body").unbind("touchstart"),
                v("body").unbind("touchmove"),
                v("body").unbind("touchend"),
                v("#swipebox-slider").unbind(),
                v("#swipebox-overlay").remove(),
                v.isArray(n) || n.removeData("_swipebox"),
    ...
    ,
    v.fn.swipebox = function(e) {
        return v.data(this, "_swipebox") || (e = new v.swipebox(this,e),
...
function(e) {
    ...
    -1 < navigator.userAgent.toLowerCase().indexOf("android") && setTimeout(function() {
...
function(c) {
    ...
    function n() {
        c('#menu-modal .menu-primary .nav-item a[href*="#"]').on("click", function(e) {
            ...
            var t = this.hash
              , e = c(t).offset().top;
            void 0 === e && (e = 0),
            "0" != i && c("html, body").stop().animate({
                scrollTop: e
            }, i, function() {
                window.location.hash = t
            })
        });
        var n, r = (e = c("#header .menu-primary .nav")).outerHeight() + 15, a = e.find("a"), s = a.map(function() {
        ...
        a.click(function(e) {
            ...
            -1 != t.indexOf("#") && 0 == t.indexOf("#") && (t = "#" === t ? 0 : c(t).offset().top,
            e.preventDefault(),
        ...
        c(window).scroll(function(e) {
            var t, i = c(window).width();
            c("body").hasClass("header-fixed-true") && media_md < i && (t = c(this).scrollTop() + r,
            i = (i = (i = s.map(function() {
                if (c(this).offset().top < t)
                    return this
            }))[i.length - 1]) && i.length ? i[0].id : "",
            n !== i && ("" != (n = i) ? location.hash = "#!" + i : history.replaceState(null, null, " "),
            c("body").hasClass("button-clicked-true") || a.parent().removeClass("active").end().filter("[href='#" + i + "']").parent().addClass("active")))
        });
        var o, l, d, u, e = (o = function() {
        ...
        c(document).ready(function() {
            var e;
            void 0 === window.location.href.split("#!")[1] || (e = "#" + window.location.href.split("#!")[1]) && c("html, body").stop().animate({
                scrollTop: c(e).offset().top
            }, i, function() {
                window.location.hash = e
            })
        }),
        c(window).on("load", function() {
            c("html").hasClass("elementor-adv") || setTimeout(function() {
                var e = c(document)
    ...
    c(function() {
        var e, t;
        c(".scroll-to-id").length && c(".scroll-to-id").click(function(e) {
            var t;
            "" !== this.hash ? (e.preventDefault(),
            t = this.hash,
            void 0 === (t = c(t).offset().top) && (t = 0)) : t = 0,
            c("html, body").stop().animate({
                scrollTop: t
            }, i, function() {})
        }),
        t = -1,
        c(".service-items").length && (t = 67),
        e = c("body.elementor-page").length ? '#main > .content > .clearfix [class*="-section-wrap"] > *:nth-child(2)' : "#main > .content > .clearfix > *:nth-child(2)",
        c("body").hasClass("header-fixed-true") && c("#header").length && c(e).length && c(window).scroll(function() {
            c(window).scrollTop() - c(e).offset().top > t ? (c("#header").addClass("animated slideInDown"),
            c(".header-fixed-true").addClass("header-fixed")) : (c("#header").removeClass("animated slideInDown"),
            c(".header-fixed-true").removeClass("header-fixed"))
        }),
        n()
    })
}(jQuery),
function(e) {
    "use strict";
    e(".scrollbar-light").mCustomScrollbar({
        theme: "light"
    }),
    e(".scrollbar-dark").mCustomScrollbar({
        theme: "dark"
    })
}(jQuery),
function(t) {
    ...
    t(".dropdown-child-click-effect .dropdown-toggle").click(function(e) {
        ...
        t(this).parent().find(".dropdown-menu").first().stop(!0, !0).slideToggle(300)
    }),
    ...
    t(".dropdown-hover, .dropdown-hover .dropdown-submenu").on("mouseenter mouseleave", function() {
        ...
        t(this).find("> .dropdown-item:not(.active)").toggleClass("active"),
        t(this).find(".dropdown-menu").first().stop(!0, !0).fadeToggle(300)
    }),
    t(".dropdown-menu [data-toggle='dropdown']").on("click", function(e) {
        ...
        t(this).parents(".show").on("hidden.bs.dropdown", function(e) {
            t(".show").removeClass("show"),
            t(":not(.current-dropdown-item).active").removeClass("active")
        })
    })
}(jQuery),
function(i) {
...
function(e) {
    ...
    jQuery(document).ajaxComplete(function() {
        jQuery('[class*="-form"]').hasClass("sent") && e('.form-label-effect [class*="form-label-effect"]').removeClass("has-content")
    })
}(jQuery),
function(t) {
    "use strict";
    ...
    t(".modal").on("hidden.bs.modal", function(e) {
        ...
        t(".modal").hasClass("in show") && t("body").addClass("modal-open")
    }),
    t('.modal .menu-primary ul li a[href*="#"]').on("click", function(e) {
        e.preventDefault();
        var i = t(e.target);
        t(this).closest(".modal").on("hidden.bs.modal", function(e) {
            var t = i.attr("href");
...
function(e) {
    "use strict";
    var t = new Swiper(".adv-slider-reviews .adv-swiper-container.reviews-thumbs",{
        noSwipingClass: "adv-swiper-no-swiping",
        containerModifierClass: "adv-swiper-container-",
        slideClass: "adv-swiper-slide",
        slideBlankClass: "adv-swiper-slide-invisible-blank",
    ...
    t.on("click", function() {
        void 0 !== this.clickedSlide && (e("#reviews-name").html(this.clickedSlide.dataset.reviewsName),
        e("#reviews-positions").html(this.clickedSlide.dataset.reviewsPosition))
    }),
...
function(t) {
    "use strict";
    t("#plans-modal").on("show.bs.modal", function(e) {
        e = t(e.relatedTarget).data("whatever");
        t(this).find(".plans-modal-content .modal-t-head .modal-title-result").text(e)
    })
}(jQuery),
function(e) {
    "use strict";
    e(".main-pb-0").length && e(".site-main").addClass("pb-0"),
    e('[class*="bg-"][class*="-full-width"]').length && e("body").addClass("overflow-x")
}(jQuery),
function(t) {
    "use strict";
    t("#blog #results .no-thumbnail").length && (t("#blog #results").masonry({
    ...
    t(document).ajaxComplete(function() {
        ...
        t("#blog #results").masonry("reloadItems"),
        t("#blog #results").masonry("layout"),
        t("html").css("scroll-behavior", "unset"),
        window.scrollTo(0, e),
        t("html").css("scroll-behavior", "smooth")
    }))
}(jQuery),
function(n) {
    "use strict";
    var r = n(".contact-form, #commentform")
    ...
    r.on("submit", function(e) {
        ...
        n.ajax({
            ...
            success: function(e) {
                ...
                "success" == e.status && (t = "Sender's message was sent successfully"),
                "warning" == e.status && (t = "Fill up the form, please!"),
                "error" == e.status && (t = i),
                o(t, e.status)
            },
            error: function(e) {
    ...
    function o(e, t) {
        ...
        "error" == t && (i = "danger"),
        "warning" == t && (i = "warning");
        e = '<div class="animated fadeIn alert alert--shadow alert-' + i + '">' + e + "</div>";
        n(r).append(e),
        clearTimeout(a),
        a = setTimeout(function() {
            n(".alert").stop().fadeOut(function() {
                n(this).remove()
            })
        }, s)
    }
    n(function() {
        n("body").on("click", ".alert__button", function(e) {
            e.preventDefault(),
            n(this).parents(".alert").fadeOut("fast", function() {
                n(this).remove(),
                clearTimeout(a)
            })
        })
...
function(i) {
    ...
    i(function() {
        ...
        n.length && i(window).scroll(function() {
            var e, t;
            n.length && (e = i(window).scrollTop() - n.offset().top,
            t = n.width(),
            n.find(">").toggleClass("sticky-fixed-md", 0 < e).width(t))
        })
    })
}(jQuery);
