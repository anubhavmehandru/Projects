														...
														<div class="panel-footer phead" >
														        <table class="tool">
																	<tr>
																		...
																		<th><span class="glyphicon" style="color:black;"> Serial No </span></th>
																		<th>
																			<input type="text" id="serialno" style="padding:2px;font-size:12px;width:120px;">
																		</th>
																		<th><span class="glyphicon" style="color:black;"> Name </span></th>
																		<th>
																			<input type="text" id="nm" style="padding:2px;font-size:12px;width:120px;">
																		</th>
																		<th><span class="glyphicon" style="color:black;"> Contact </span></th>
																		<th>
																			<input type="text" id="contact" style="padding:2px;font-size:12px;width:120px;">
																		</th>
