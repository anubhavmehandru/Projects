...
<?php
    ...
    if(isset($_POST['sub']))
    {
		...
		if(mysqli_query($con,$sql))
		{
				...
				$templateid="1207162926880802156";
$msg="Welcome to 3CM Service. Job Id is $srno for $model serial number $serialno. For detail contact 01615033620, 8283840003.

Terms and Conditions
Diagnostic Charges Rs.300/- if $product taken unrepaired.

Delivery will be made strictly against OTP.

If Equipment is not picked within 15 days from the date of repair confirmation / unapproved, for whatever reason, additional warehousing charges of Rs.30 per day will be charged.";


				$data = "username=3cm.mehandru&password=17251672&source=ThreCM&dmobile=91$contact&dltentityid=1201162667665270193&dltheaderid=1205162672585630734&dlttempid=$templateid&message=$msg";
				...
				$sqlsms="insert into `sms` values(null,'$id','1','0','0','0')";
				if (mysqli_query($con,$sqlsms))
				{
					echo '<script>alert("SMS 1")</script>';
				}


				$ch = curl_init('https://www.txtguru.in/imobile/balancecheckapi.php?username=3cm.mehandru&&password=17251672');
				curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
				$response = curl_exec($ch);
				curl_close($ch);
				if($response<=200)
				{
					echo '<script>alert("Please buy more SMS only '.$response.' messages are left now.")</script>';
				}
                         ...
                         <div class="panel-body">
							<h4 style="margin-top:-5px;margin-bottom:2px;">Add New Call</h4>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <input type="text" name="contactname" class="form-control" id="cap2" onkeyup="cap(this.id)"  required="required" >
                                        </div>
                                </div>
								<div class="form-group">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                                <input type="text" name="serialno" class="form-control" id="cap5" onkeyup="cap(this.id)" required="required">
                                        </div>
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-4">
                                                <input type="text" name="problem" class="form-control" placeholder="Seprate with comma(,) operator" id="cap6" onkeyup="cap(this.id)" required="required">
                                        </div>
                                </div>                                
                                <div class="form-group">
							   ...
							   <div class="form-group">
                                        ...
                                        <div class="col-md-3 checkbox">
                                                 <label>
                                                            <input type="radio" name="warranty" value="warranty"  class="war"> In-Warranty
                                                 </label>
                                        </div>  
										
                                        <div class="col-md-3 checkbox">
                                                 <label>
                                                            <input type="radio" name="warranty" value="nwarranty" class="war" checked="checked"> Non-Warranty
                                                 </label>
                                        </div> 
											<div class="col-md-3" id="rma" style="display:none;" >
													<input type="text" name="rma" class="form-control" placeholder="RMA No" id="cap8" onkeyup="cap(this.id)">
											</div>
											<div class="col-md-3" id="receipt" >
													<input type="text" name="receipt" class="form-control"  placeholder="Receipt No" id="cap9" onkeyup="cap(this.id)" required="required">
											</div>
                                </div> 
								<script>
										$(document).ready(function(){
                                ...
                                <div class="form-group" id="onsiteaddress">
                                        ...
                                        <div class="col-lg-10">
                                                <textarea class="form-control" rows="2" name="address" id="cap10" onkeyup="cap(this.id)" required="required"></textarea>
                                        </div>
                                </div>
                                <div class="form-group">
                                        <label class="col-lg-2 control-label">Remark </label>
                                        <div class="col-lg-10">
                                                <textarea class="form-control" rows="2" name="remark" id="cap11" onkeyup="cap(this.id)" required="required"></textarea>
                                        </div>
                                </div>
