...
<div class="col-md-12">
        <div class="panel panel-default">
                <form class="form-horizontal" method="post">
                            ...
                            {   
								$count++;
										...
										echo ' )	</td>
												...
												<input type='button' value='Print Job Card' class='btn btn-success' style='margin-top:-150px;margin-right:5px;'></a>";
							}
						}
						$sql="select * from `rassign` where `callid`='$_GET[view]'";
						$result=mysqli_query($con,$sql);
						...
						$sql="select * from sms_dt where `callid`='$_GET[view]'";
						$result=mysqli_query($con,$sql);
						$record=mysqli_num_rows($result);
						if($record>0)
						{
                            ...
                            {   
								$count++;
										echo '<tr>
													<td>'.$count.'</td>
													<td>Customer informed and OTP sent</td>
													<td>'.$row['rep_sms_date'].'</td>
													<td>'.$row['rep_sms_time'].'</td>
												</tr>';
