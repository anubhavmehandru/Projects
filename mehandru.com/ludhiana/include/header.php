                                            ...
                                            <div class="collapse navbar-collapse navHeader-collepse">
                                                            ...
                                                            <ul class="nav navbar-nav">  
																	...
																	?>
																					...
																					<li><a href="?page=main">Calls</a></li>
																					<li><a href="?page=user">User</a></li>
																					<li><a href="?page=spare">Spare Parts</a></li>
																					<li><a href="?page=report">Report's</a></li>
																					<li><a href="?page=parts">Parts</a></li>
															...
															<ul class="nav navbar-nav pull-right">
																	...
																	<li><a href=""><span class="glyphicon glyphicon-user"></span> &nbsp;&nbsp;<?php echo $_SESSION['status']; ?></a></li>
                                            ...
                                            <div class="modal-body" style="overflow:hidden;">
                                                <div class="row">
                                                        <?php
                                                            ...
                                                            $a=$total=mysqli_num_rows($result);
                                                            $b=$pending=mysqli_num_rows($result1);
                                                            $c=$lost=mysqli_num_rows($result2);
                                                            $d=$complete=mysqli_num_rows($result3);
